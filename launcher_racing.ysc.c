...
BOOL func_74(Player plParam0, int iParam1) // Position - 0x2568
{
	BOOL flag;
...
BOOL func_76(Player plParam0) // Position - 0x2602
{
	Player player;
...
BOOL func_77(Player plParam0) // Position - 0x2624
{
...
int func_79(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2671
{
	int num;
...
void func_83(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x284A
{
	...
	if (bParam3)
	{
		...
		{
			func_113(Global_23970.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 && Global_23970.f_6331)
		{
			...
			else
			{
				if (Global_23970)
				{
					...
					{
						func_108(Global_23967, Global_23968, iParam5, height3, 0, 0, 0, 255);
				...
				func_108(Global_23967, Global_23968 + height3, iParam5, 0.034722f, r, g, b, a);
				...
				{
					func_107();
					func_105((Global_23967 + iParam5) - 0.00390625f - func_106("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340);
				}
				else if (Global_23970.f_6334 > Global_23970.f_5828)
				{
					...
					{
						func_107();
						func_105((Global_23967 + iParam5) - 0.00390625f - func_106("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336);
					}
				}
			}
			...
			if (Global_23970.f_6334 > Global_23970.f_5828)
			{
				...
				func_108(Global_23967, num28 + 0f, iParam5, 0.034722f, r, g, b, a);
			...
			if (MISC::GET_HASH_KEY(&(Global_23970.f_5241)) != 0 && Global_23970.f_5323 != -1)
			{
				...
				{
					func_119(Global_23970.f_5325, true, true, &width, &height, bParam7);
				...
				func_108(Global_23967, num28 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_119(Global_23970.f_5325, true, true, &width, &height, bParam7);
					func_103(Global_23970.f_5325, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_5325), func_109(Global_23970.f_5325, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542374.f_21)) != 0 && Global_4542374.f_65 != -1)
			{
				...
				{
					func_119(Global_4542374.f_67, true, true, &width, &height, bParam7);
					x = (Global_23967 + width + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_119(Global_4542374.f_67, true, true, &width, &height, bParam7);
					func_103(Global_4542374.f_67, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_112(Global_4542374.f_67), func_109(Global_4542374.f_67, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
						...
						switch (Global_23970.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0)
										{
											...
											func_96(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, num35, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_119(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													num25 = num25 + width;
									...
									if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_96(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23970.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_119(Global_23970.f_4984[num14 + num20], flag, false, &width, &height, bParam7))
												{
													x = x + (width * 0.5f);
												
													if (func_119(Global_23970.f_4984[num14 + num20], flag, true, &width, &height, bParam7))
													{
														func_103(Global_23970.f_4984[num14 + num20], flag, &red, &green, &blue, &alpha);
													
														if (i == 1)
															if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14 + num20]), func_109(Global_23970.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14 + num20]), func_109(Global_23970.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_96(false, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23970.f_4984[num14 + l] != 2 && Global_23970.f_4984[num14 + l] != 54 && Global_23970.f_4984[num14 + l] != 64)
											{
												if (func_119(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_119(Global_23970.f_4984[num14 + l], flag, true, &width, &height, bParam7))
														{
															func_103(Global_23970.f_4984[num14 + l], flag, &red, &green, &blue, &alpha);
														
															if (Global_23970.f_4984[num14 + l] == 30)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14 + l]), func_109(Global_23970.f_4984[num14 + l], flag), Global_23967 + (width * 0.5f), (y + 0.00277776f + (height * 0.5f)) - (0.00078125f * 11f), width, height, 0f, red, green, blue, alpha, false, 0);
															else if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14 + l]), func_109(Global_23970.f_4984[num14 + l], flag), ((num24 + x + screenWidthOfDisplayText) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14 + l]), func_109(Global_23970.f_4984[num14 + l], flag), (num24 + x + screenWidthOfDisplayText) - (0.00078125f * 12f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										func_96(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_96(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
										func_93(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_96(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									func_92(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4726[num13], Global_23970.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_119(Global_23970.f_4984[num14], flag, false, &width, &height, bParam7))
									{
										if (!Global_23970.f_6332)
										{
											num25 = width;
										...
										if (i == 1)
										{
											if (func_119(Global_23970.f_4984[num14], flag, true, &width, &height, bParam7))
											{
												func_103(Global_23970.f_4984[num14], flag, &red, &green, &blue, &alpha);
												GRAPHICS::DRAW_SPRITE(func_112(Global_23970.f_4984[num14]), func_109(Global_23970.f_4984[num14], flag), num24 + x + (width * 0.5f), (y - 0.00277776f) + (height2 * 0.5f), width * func_91(Global_23970.f_4984[num14]), height * func_91(Global_23970.f_4984[num14]), 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
								}
...
void func_93(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x5C4D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x5C6B
{
...
void func_96(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5CC2
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_97(Global_23970.f_6614[iParam4], &r, &g, &b);
...
void func_103(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x66A7
{
...
void func_105(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x6827
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(epctParam3);
...
float func_106(char* sParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x684A
{
...
char* func_110(const char* sParam0) // Position - 0x6E6F
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x6E79
{
	var gamerHandle;
...
void func_113(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6F05
{
	int num;
	float num2;
	float num3;
...
void func_116(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x717A
{
	int num;
...
void func_117(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x71C6
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_121(BOOL bParam0, BOOL bParam1) // Position - 0x7469
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_123(8, -1) && func_122() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79800 || Global_23970.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101740.f_1490)
		return false;

	return true;
}

eTransitionState func_122() // Position - 0x7506
{
...
void func_129(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x78B8
{
...
BOOL func_135(int* piParam0) // Position - 0x809E
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_143(int* piParam0) // Position - 0x8489
{
	func_144(piParam0, 0f);
	return;
}

void func_144(int* piParam0, float fParam1) // Position - 0x8498
{
...
void func_145(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x84C3
{
...
BOOL func_158(Hash hParam0) // Position - 0x8F9F
{
	switch (hParam0)
	{
		case joaat("police"):
...
void func_160(Vehicle* pveParam0) // Position - 0x9093
{
...
BOOL func_168(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9948
{
...
BOOL func_170(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x99BF
{
...
BOOL func_174(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x9A9E
{
...
void func_177(int* piParam0) // Position - 0x9C30
{
	func_178(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_178(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0x9C46
{
...
Hash func_182(int iParam0) // Position - 0xA794
{
	int num;
...
void func_186(Ped pedParam0, BOOL bParam1) // Position - 0xAE5F
{
	char* str;
	int endRange;
...
BOOL func_188(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB125
{
	float num;
...
BOOL func_189(Vehicle veParam0, int iParam1) // Position - 0xB1E0
{
	float xSize;
...
BOOL func_190(Vehicle veParam0, int iParam1) // Position - 0xB256
{
	return func_191(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_191(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB26E
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_192(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xB32F
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_193(Ped pedParam0, int iParam1) // Position - 0xB45B
{
	int randomIntInRange;
...
BOOL func_195(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xB56A
{
	var unk;
...
int func_199(Vehicle veParam0, Ped pedParam1) // Position - 0xB676
{
	int i;
...
BOOL func_200(Vehicle veParam0) // Position - 0xB6B5
{
...
BOOL func_201(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xB6DD
{
...
BOOL func_202(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB724
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_203(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB81F
{
	float entityCoords;
	float num;
...
BOOL func_204(Vehicle veParam0, float fParam1) // Position - 0xB92B
{
	var outProjectile;
	var outCoords;
...
BOOL func_205(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xB9C0
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_206(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xBA4E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_207(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xBA96
{
...
int func_210(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0xBC4A
{
	var unk;
...
void func_214(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xBD68
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_175(iParam0))
