...
void func_11(int* piParam0) // Position - 0x3AD
{
	...
	switch (iLocal_298)
	{
		case 0:
			...
			MISC::CLEAR_BIT(&(iLocal_269.f_20), 0);
		...
		case 1:
			...
			{
				func_59();
				func_56(piParam0, &iLocal_269, 240000);
				func_92(3);
			}
			else if (func_50())
			{
			...
			if (func_48(0, -1, false))
				func_37(x, -1, 0, true, false, false, true, 1, false);
			break;
		...
		case 3:
			...
			{
				GRAPHICS::DRAW_SPRITE("MPHotwire", "failed", 0.5f, 0.5f, 0.344f / fLocal_159, 0.127f, 0f, 255, 255, 255, SYSTEM::ROUND(iLocal_269.f_26), false, 0);
			
				if (iLocal_269.f_26 < 255f)
					iLocal_269.f_26 = iLocal_269.f_26 + (255f * SYSTEM::TIMESTEP());
				else
...
void func_14(int* piParam0) // Position - 0x871
{
	if (piParam0->f_9 != 0)
	{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x95B
{
...
void func_27() // Position - 0xA95
{
	...
	screenY = 0.511f;
	num = 0.454f * 50f;
	GRAPHICS::DRAW_SPRITE("MPHotwire", "passed", 0.5f, 0.5f, 0.344f / fLocal_159, 0.127f, 0f, 255, 255, 255, SYSTEM::ROUND(iLocal_269.f_26), false, 0);
	height = 0.03f;
	...
	if (iLocal_267 != 0)
	{
		height = 0.011f;
		num2 = 0.375f;
		num3 = func_28(num2, 0.5f, iLocal_269.f_24);
		GRAPHICS::DRAW_SPRITE("MPHotwire", "load_bar", func_26(num3), screenY, (iLocal_269.f_24 * height * num) / fLocal_159, height, 90f, 255, 255, 255, 255, false, 0);
	}

	switch (iLocal_267)
	{
		case 0:
			iLocal_269.f_26 = iLocal_269.f_26 + (200f * SYSTEM::TIMESTEP());
		
			if (iLocal_269.f_26 >= 255f)
			{
				iLocal_269.f_26 = 255f;
				iLocal_267 = 1;
			}
			break;
	
		case 1:
			if (iLocal_269.f_24 < 1f)
			{
				iLocal_269.f_24 = iLocal_269.f_24 + (0.5f * SYSTEM::TIMESTEP());
		...
		case 3:
			num4 = 0.612f;
			func_25("BEAM_P" /*SUCCESS*/, 76, 190, 148, 255, num4, num4, 0.5f, 0.456f);
			break;
	}
...
void func_29(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xC37
{
	...
	statName = func_30(iParam0, iParam2);
...
Hash func_30(int iParam0, int iParam1) // Position - 0xC5A
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_31(iParam1));
}
...
BOOL func_40(Player plParam0, int iParam1) // Position - 0x12BC
{
	BOOL flag;
...
BOOL func_42(Player plParam0) // Position - 0x1356
{
	Player player;
...
eTransitionState func_46() // Position - 0x149D
{
...
BOOL func_49(int* piParam0) // Position - 0x15E9
{
	switch (piParam0->f_9)
	{
		case 0:
...
BOOL func_50() // Position - 0x168B
{
	...
	if (_STOPWATCH_IS_INITIALIZED(&(iLocal_269.f_2)))
	{
		if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_269.f_2), iLocal_269.f_22, false))
		{
			if (iLocal_267 == 4)
			{
				num = 1;
				iLocal_267 = 0;
				func_92(2);
				_STOPWATCH_DESTROY(&(iLocal_269.f_2));
			}
		}
	}
	else if (func_55())
...
{
	_STOPWATCH_RESET(&(iLocal_269.f_2), false, false);
	iLocal_267 = 0;
	func_92(2);
	return;
}
...
BOOL func_52() // Position - 0x171A
{
	...
	{
		unk6 = iLocal_269.f_15[0];
		unk7 = iLocal_269.f_15[2];
		iLocal_269.f_15[0] = iLocal_269.f_15[3];
		iLocal_269.f_15[2] = unk6;
		iLocal_269.f_15[3] = unk7;
	}

	for (i = 0; i < 4; i = i + 1)
	{
		if (iLocal_269.f_10[i] == iLocal_269.f_15[i])
		{
			MISC::SET_BIT(&(iLocal_269.f_21), iLocal_269.f_10[i]);
			unk[i] = 1f;
			num = num + 1;
		}
		else
		{
			iLocal_269.f_4[iLocal_269.f_10[i]] = iLocal_269.f_4[iLocal_269.f_10[i]] - 1;
			MISC::CLEAR_BIT(&(iLocal_269.f_21), iLocal_269.f_10[i]);
			unk[i] = 0f;
			iLocal_269.f_10[i] = -1;
			...
			if (iLocal_269.f_4[i] < 1)
				MISC::SET_BIT(&(iLocal_269.f_20), 0);
		
			fLocal_164 = fLocal_164 + 0.075f;
		}
	}

	if (!IS_BIT_SET(iLocal_269.f_20, 0))
	{
		soundId = AUDIO::GET_SOUND_ID();
		AUDIO::PLAY_SOUND_FRONTEND(soundId, "Test_Circuit", sLocal_162, true);
...
void func_56(int* piParam0, var uParam1, int iParam2) // Position - 0x1928
{
	piParam0->f_1 = func_57(_STOPWATCH_GET_TIME_PASSED(uParam1, false, false), 0, iParam2);
	return;
}
...
{
	if (_STOPWATCH_HAS_TIME_PASSED(&iLocal_269, 240000, false))
		return true;
...
void func_61() // Position - 0x1A0D
{
	...
	switch (iLocal_268)
	{
		...
		case 3:
			...
			if (iLocal_269.f_9 > -1)
				if (iLocal_269.f_10[iLocal_269.f_9] > -1)
					func_53(4);
			else
				func_53(4);
			break;
		...
		case 5:
			...
			if (!func_55())
			{
				_STOPWATCH_INITIALIZE(&(iLocal_269.f_27), false, false);
				func_53(6);
			}
			break;
		...
		case 6:
			...
			if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_269.f_27), 8500, false))
			{
				_STOPWATCH_DESTROY(&(iLocal_269.f_27));
				func_53(0);
			}
			break;
		...
		case 7:
			...
			if (_STOPWATCH_IS_INITIALIZED(&(iLocal_269.f_27)))
				if (_STOPWATCH_HAS_TIME_PASSED(&(iLocal_269.f_27), 8500, false))
					func_53(0);
			else
				_STOPWATCH_RESET(&(iLocal_269.f_27), false, false);
			break;
	}
...
void func_63() // Position - 0x1B7E
{
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL))
	{
		fLocal_301 = PAD::GET_CONTROL_NORMAL(FRONTEND_CONTROL, INPUT_CURSOR_X);
		fLocal_301.f_1 = PAD::GET_CONTROL_NORMAL(FRONTEND_CONTROL, INPUT_CURSOR_Y);
	}
	else
	{
		...
		if (controlNormal > 0.1f || controlNormal < -0.1f)
			fLocal_301 = fLocal_301 + ((controlNormal / 1.5f) * SYSTEM::TIMESTEP());
	
		if (controlNormal2 > 0.1f || controlNormal2 < -0.1f)
			fLocal_301.f_1 = fLocal_301.f_1 + ((controlNormal2 / 1.5f) * SYSTEM::TIMESTEP());
	...
	if (num2 > -1)
	{
		unk = { uLocal_319[num2 /*4*/] };
	
		if (iLocal_269.f_9 == -1)
		{
			num3 = SYSTEM::TO_FLOAT(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_269)));
			num4 = 0.5f;
	...
	{
		num5 = func_71();
		func_65(func_69(iLocal_269.f_9), fLocal_301);
		...
		if (num5 > -1)
		{
			...
			{
				func_75(&unk, 255, 0, 0, 255);
				num6 = SYSTEM::TO_FLOAT(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_269)));
				num7 = 0.5f;
				num = (SYSTEM::SIN(num6 * num7) * 0.019f) + 0.001f;
			
				if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL) && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CURSOR_ACCEPT))
				{
					iLocal_269.f_10[iLocal_269.f_9] = num5;
					iLocal_269.f_9 = -1;
	...
	num8 = 0.1f + num;
	GRAPHICS::DRAW_SPRITE("MPHotwire", "Cursor_0", func_26(fLocal_301), fLocal_301.f_1, (1f / fLocal_159) * num8, 1f * num8, 0f, 255, 255, 255, 255, false, 0);
	return;
}
...
void func_65(float fParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1E20
{
	...
	GRAPHICS::DRAW_SPRITE_ARX("MPHotwire", "line", func_26(num), num.f_1, num2 / fLocal_159, 0.004f, num3, 255, 255, 255, 255, 0, 0);
	return;
}
...
void func_77() // Position - 0x20B9
{
	...
	if (_STOPWATCH_IS_INITIALIZED(&iLocal_269))
	{
		num = 240000 - _STOPWATCH_GET_TIME_PASSED(&iLocal_269, false, false);
		value = num / 60000;
		value2 = (num / 1000) % 60;
	...
	if (func_55())
	{
		func_78(INPUT_FRONTEND_CANCEL, "HWSF_QT", -1);
		func_78(INPUT_FRONTEND_Y, "HWSF_TST", -1);
	}
	else if (iLocal_269.f_9 > -1)
	{
		func_78(INPUT_FRONTEND_CANCEL, "HWSF_QT", -1);
	
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		{
			func_78(INPUT_CURSOR_ACCEPT, "HWSF_CONN", -1);
			func_78(INPUT_CURSOR_X, "HWSF_MWRE", -1);
		}
		else
		{
			func_78(INPUT_FRONTEND_ACCEPT, "HWSF_CONN", -1);
			func_78(INPUT_FRONTEND_AXIS_X, "HWSF_MWRE", -1);
		}
	}
	else
	{
		...
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		{
			func_78(INPUT_CURSOR_ACCEPT, "HWSF_SEL", -1);
			func_78(INPUT_CURSOR_X, "HWSF_MCUR", -1);
		}
		else
		{
			func_78(INPUT_FRONTEND_ACCEPT, "HWSF_SEL", -1);
			func_78(INPUT_FRONTEND_AXIS_X, "HWSF_MCUR", -1);
		}
	}
...
void func_78(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x220F
{
...
void func_82() // Position - 0x2355
{
	...
	{
		if (iLocal_269.f_10[i] != -1)
			func_90(i, iLocal_269.f_10[i]);
	}

	for (i = 0; i <= 3; i = i + 1)
	{
		flag = func_74() == i;
		flag2 = func_71() == i && iLocal_269.f_9 > -1 && !func_64(i);
		flag3 = func_62() && iLocal_268 == 1 && i == 1;
		flag4 = func_62() && iLocal_268 == 3 && i == iLocal_269.f_15[1];
	
		if (iLocal_268 == 4)
			if (iLocal_269.f_9 > -1)
				if (!func_64(i))
					flag4 = true;
			else if (iLocal_269.f_10[i] == -1)
				flag3 = true;
	
		alpha = SYSTEM::ROUND(func_89(0, 0.4f));
		num = { func_67(func_68(uLocal_165.f_28[i /*9*/][0 /*2*/], uLocal_165.f_28[i /*9*/][2 /*2*/]), 2f) };
	
		if (flag3)
			GRAPHICS::DRAW_SPRITE("MPHotwire", "leftnode_roll", func_26(num), num.f_1, (0.17f * 1.01f) / fLocal_159, 0.062f * 1.01f, 0f, 255, 255, 0, alpha, false, 0);
	
		if (flag)
		{
			func_88(i, -1);
			GRAPHICS::DRAW_SPRITE("MPHotwire", "leftnode_roll", func_26(num), num.f_1, 0.17f / fLocal_159, 0.062f, 0f, 255, 255, 255, 255, false, 0);
		}
		else
		{
			MISC::CLEAR_BIT(&(iLocal_269.f_20), 1 + i);
			GRAPHICS::DRAW_SPRITE("MPHotwire", "leftnode", func_26(num), num.f_1, 0.164f / fLocal_159, 0.056f, 0f, 255, 255, 255, 255, false, 0);
		}
	
		num = { func_67(func_68(uLocal_165.f_65[i /*9*/][0 /*2*/], uLocal_165.f_65[i /*9*/][2 /*2*/]), 2f) };
	
		if (flag4)
			GRAPHICS::DRAW_SPRITE("MPHotwire", "rightnode_roll", func_26(num), num.f_1, (0.17f * 1.01f) / fLocal_159, 0.062f * 1.01f, 0f, 255, 255, 0, alpha, false, 0);
	
		if (flag2)
		{
			func_88(-1, i);
			GRAPHICS::DRAW_SPRITE("MPHotwire", "rightnode_roll", func_26(num), num.f_1, 0.17f / fLocal_159, 0.062f, 0f, 255, 255, 255, 255, false, 0);
		}
		else
		{
			MISC::CLEAR_BIT(&(iLocal_269.f_20), 5 + i);
			GRAPHICS::DRAW_SPRITE("MPHotwire", "rightnode", func_26(num), num.f_1, 0.164f / fLocal_159, 0.056f, 0f, 255, 255, 255, 255, false, 0);
		}
	
		unk2 = { func_86(0.851f, func_87(i)) };
		func_85(unk2, IS_BIT_SET(iLocal_269.f_21, i));
	
		if (iLocal_269.f_4[i] < 1)
			func_83(func_84(i, 0));
	
		if (iLocal_269.f_4[i] < 2)
			func_83(func_84(i, 1));
	
		if (iLocal_269.f_4[i] < 3)
			func_83(func_84(i, 2));
	
		if (iLocal_269.f_4[i] < 4)
			func_83(func_84(i, 3));
	}
...
void func_83(float fParam0, var uParam1) // Position - 0x26C1
{
	...
	height = 0.02f;
	num = SYSTEM::TO_FLOAT(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_269))) + (fParam0.f_1 * 9999f);
	num2 = 0.5f;
	num3 = SYSTEM::SIN(num * num2 * 1f) + 0.1f;
	alpha = SYSTEM::ROUND(255f * num3);
	GRAPHICS::DRAW_SPRITE("MPHotwire", "lifelight", func_26(fParam0), fParam0.f_1, height / fLocal_159, height, 0f, 255, 255, 255, alpha, false, 0);
	return;
}
...
void func_85(float fParam0, var uParam1, BOOL bParam2) // Position - 0x2902
{
	...
	height = 0.018f;
	alpha = SYSTEM::ROUND(func_89(fParam0.f_1 * 9999f, 1050253722));

	if (bParam2)
		GRAPHICS::DRAW_SPRITE("MPHotwire", "correctlight", func_26(fParam0), fParam0.f_1, height / fLocal_159, height, 0f, 255, 255, 255, 255, false, 0);
	else
		GRAPHICS::DRAW_SPRITE("MPHotwire", "wronglight", func_26(fParam0), fParam0.f_1, height / fLocal_159, height, 0f, 255, 255, 255, alpha, false, 0);
...
void func_88(int iParam0, int iParam1) // Position - 0x29DA
{
	if (iParam0 > -1)
	{
		if (!IS_BIT_SET(iLocal_269.f_20, 1 + iParam0))
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "Output_Highlight", sLocal_162, true);
			MISC::SET_BIT(&(iLocal_269.f_20), 1 + iParam0);
		}
	}

	if (iParam1 > -1)
	{
		if (!IS_BIT_SET(iLocal_269.f_20, 5 + iParam1))
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "Input_Highlight", sLocal_162, true);
			MISC::SET_BIT(&(iLocal_269.f_20), 5 + iParam1);
		}
	}
...
float func_89(int iParam0, int iParam1) // Position - 0x2A3C
{
	...
	num = SYSTEM::TO_FLOAT(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iLocal_269))) + iParam0;
...
void func_90(int iParam0, var uParam1) // Position - 0x2A77
{
	...
	func_91(iParam0, uParam1, &num, &screenY, &num2, &height, &heading, &textureName, &num3, &screenY2, &heading2, &flag);
	GRAPHICS::DRAW_SPRITE("MPHotwire", &textureName, func_26(num), screenY, num2 / fLocal_159, height, heading, 255, 255, 255, 255, false, 0);

	if (flag)
		GRAPHICS::DRAW_SPRITE("MPHotwire", &textureName, func_26(num3), screenY2, num2 / fLocal_159, height, heading2, 255, 255, 255, 255, false, 0);
...
int func_93(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3038
{
	int num;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x308A
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_40(PLAYER::PLAYER_ID(), 0) && !func_104() && !func_103(PLAYER::PLAYER_ID()))
...
BOOL func_99(Ped pedParam0) // Position - 0x35D6
{
...
void func_100(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x3607
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x36D7
{
	Hash statName;
...
BOOL func_103(Player plParam0) // Position - 0x374B
{
	if (func_40(plParam0, 0))
		return true;
...
void func_106() // Position - 0x37C9
{
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		...
		unk = iLocal_269.f_15[num];
		iLocal_269.f_15[num] = iLocal_269.f_15[i];
		iLocal_269.f_15[i] = unk;
	}
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x383E
{
	...
	statHash = func_30(iParam0, iParam1);
...
{
	func_75(&iLocal_303, 255, 255, 255, 255);
...
void func_110() // Position - 0x3DC2
{
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		iLocal_269.f_4[i] = 4;
		iLocal_269.f_10[i] = -1;
		MISC::CLEAR_BIT(&(iLocal_269.f_21), i);
	}
...
void func_111() // Position - 0x3E29
{
	...
	GRAPHICS::DRAW_SPRITE("MPHotwire", "bg", 0.5f, 0.5f, 1f * fLocal_160, 1f, 0f, iLocal_303, iLocal_303.f_1, iLocal_303.f_2, iLocal_303.f_3, false, 0);
	return;
}
...
void func_114() // Position - 0x3F0B
{
	...
	if (func_15(&num, false, -1) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_23970.f_6263[num /*10*/]))
		func_115(-1);
...
void func_116(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4012
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x49A7
{
	switch (func_142())
	{
		case 0:
...
void func_151() // Position - 0x4A93
{
	...
	MISC::COPY_SCRIPT_STRUCT(&Global_1957673, &src, 2);
	return;
}
