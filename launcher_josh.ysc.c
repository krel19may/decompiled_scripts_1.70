...
ePedComponentType func_83() // Position - 0x7746
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x778A
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8641
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
int func_98(Player plParam0) // Position - 0x8939
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x901F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x9035
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x904B
{
...
void func_127(Ped pedParam0) // Position - 0xACBE
{
	int num;
	int num2;
	int num3;
...
int func_129(Ped pedParam0) // Position - 0xAD9A
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAEFA
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAF43
{
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB086
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB226
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB38F
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB429
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB44B
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB498
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB515
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB648
{
...
void func_160(Vehicle veParam0) // Position - 0xB69F
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_178(const char* sParam0, int iParam1) // Position - 0xBE75
{
	int num;
	const char* str;
	Hash hashKey;
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC353
{
	Blip blip;
...
float func_185(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xC4A4
{
...
BOOL func_187(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC595
{
...
BOOL func_194(Vehicle veParam0) // Position - 0xCFE6
{
...
BOOL func_209(Player plParam0) // Position - 0xDC95
{
	return func_210(plParam0, 20);
}

BOOL func_210(Player plParam0, int iParam1) // Position - 0xDCA5
{
...
void func_216(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF17
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDF6D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE051
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_229(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xE408
{
	Vector3 entityCoords;
...
void func_231(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE6B2
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_236(Object* pobParam0) // Position - 0xED6B
{
...
BOOL func_238(Ped pedParam0, Vehicle veParam1) // Position - 0xEF54
{
...
BOOL func_241(Ped pedParam0, int iParam1) // Position - 0xF274
{
	float xSize;
...
BOOL func_242(Ped pedParam0, int iParam1) // Position - 0xF2EA
{
	return func_243(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF302
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_244(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF3C3
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_245(Ped pedParam0, int iParam1) // Position - 0xF4EF
{
...
BOOL func_247(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF5FE
{
	var unk;
...
int func_251(Ped pedParam0, Ped pedParam1) // Position - 0xF70A
{
	int i;
...
BOOL func_252(Ped pedParam0) // Position - 0xF749
{
...
BOOL func_253(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF771
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_254(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF86C
{
	float entityCoords;
	float num;
...
BOOL func_255(Ped pedParam0, float fParam1) // Position - 0xF978
{
	var outProjectile;
	var outCoords;
...
BOOL func_256(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFA0D
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_257(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFA9B
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_259(Vehicle veParam0) // Position - 0xFB2D
{
	int taskSequenceId;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFD78
{
...
void func_270(Vehicle* pveParam0, BOOL bParam1) // Position - 0x1027E
{
	var unk;
	float num;
...
void func_271(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x102F2
{
	func_272(pveParam0);
...
void func_272(Vehicle* pveParam0) // Position - 0x10335
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_273(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x103D1
{
	func_274(ppedParam0);
...
void func_274(Ped* ppedParam0) // Position - 0x103F2
{
...
BOOL func_275(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10433
{
...
BOOL func_276(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x1048F
{
	Hash model;
...
int func_277(Ped pedParam0, eCharacter echParam1) // Position - 0x1051D
{
	int num;
...
void func_284(Vehicle* pveParam0) // Position - 0x108F6
{
...
void func_311(Object* pobParam0, BOOL bParam1) // Position - 0x1147C
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_314(Vehicle* pveParam0) // Position - 0x11506
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_317(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11591
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_322(eCharacter echParam0) // Position - 0x1167D
{
	if (!func_36(echParam0))
