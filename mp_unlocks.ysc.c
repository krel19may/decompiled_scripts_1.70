			...
			while (iLocal_163 == 0)
			{
				...
				if (HUD::HAS_MENU_LAYOUT_CHANGED_EVENT_OCCURRED())
				{
					...
					else
					{
						...
						{
							iLocal_167 = selectedItemUniqueId;
							func_1(&uLocal_169);
						}
					}
				}
...
int func_1(var uParam0) // Position - 0x18B
{
	...
	func_70(0, iLocal_167, false, true);
	func_69(1);
	num = 0;
...
ePedComponentType func_12(int iParam0, int iParam1) // Position - 0x1B1C
{
	ePedComponentType type;
...
ePedComponentType func_13(int iParam0, int iParam1) // Position - 0x1B34
{
	Hash statHash;
	int outValue;
...
void func_47(var uParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x26FF
{
	var unk;
	...
	if (!bParam3)
		func_49(1, *uParam0, iLocal_162, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, epctParam1, epctParam2);
	else
		func_48(1, *uParam0, iLocal_162, *uParam0, &unk, "NUMBR" /*~1~*/, epctParam1);

	*uParam0 = *uParam0 + 1;
	return;
}

void func_48(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, ePedComponentType epctParam6) // Position - 0x2753
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
void func_49(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, ePedComponentType epctParam6, ePedComponentType epctParam7) // Position - 0x27A7
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
ePedComponentType func_54(int iParam0) // Position - 0x29E5
{
	ePedComponentType type;
...
ePedComponentType func_55() // Position - 0x2BDE
{
	int num;
...
ePedComponentType func_57() // Position - 0x2C82
{
	int num;
...
ePedComponentType func_58() // Position - 0x2C9D
{
	int num;
...
ePedComponentType func_59() // Position - 0x2CB8
{
	int num;
...
ePedComponentType func_60() // Position - 0x2CD3
{
	int num;
...
ePedComponentType func_61() // Position - 0x2CF0
{
	int num;
...
int func_62(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x2D2B
{
	bParam1;
	return func_63(epctParam0, 0);
}

int func_63(ePedComponentType epctParam0, int iParam1) // Position - 0x2D3F
{
	int i;
	int value;
	int value2;
...
ePedComponentType func_64(int iParam0) // Position - 0x2DFA
{
	int num;
	int num2;
...
ePedComponentType func_65(Player plParam0, BOOL bParam1) // Position - 0x3335
{
	bParam1;
	return func_66(plParam0);
}

ePedComponentType func_66(Player plParam0) // Position - 0x3348
{
...
BOOL func_75(eControlAction ecaParam0) // Position - 0x35F1
{
	...
	if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || func_76(ecaParam0, &(Global_1673654.f_1060), 1))
	{
