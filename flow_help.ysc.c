	...
	while (true)
	{
		if (Global_114135.f_20414.f_145 > 0 || Global_112772)
		{
			...
			else if (!func_4())
			{
				...
				if (MISC::GET_GAME_TIMER() - Global_112773 > 4000 || uLocal_18.f_16)
				{
					if (uLocal_18.f_14 != 0)
			...
			if (!MISC::ARE_STRINGS_EQUAL(&Global_114135.f_20414[iLocal_35 /*16*/], &uLocal_18) && !MISC::ARE_STRINGS_EQUAL(&Global_114135.f_20414[iLocal_35 /*16*/], ""))
			{
...
BOOL func_4() // Position - 0x670
{
	...
	if (uLocal_18.f_9 != -1 && MISC::GET_GAME_TIMER() - Global_112773 > uLocal_18.f_9)
		return false;
