...
void main() // Position - 0x0
{
	...
	MISC::SET_BIT(&(Global_33467[j /*23*/].f_11), 18);
	j = 0;
		...
		if (Global_33464)
		{
			...
			for (j = 0; j < 263; j = j + 1)
			{
				...
				if (flag2)
				{
					...
					if (num6 > 0)
						if (num5 > 0)
							MISC::CLEAR_BIT(&(Global_33467[j /*23*/].f_11), 0);
						else if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 15))
							MISC::SET_BIT(&(Global_33467[j /*23*/].f_11), 0);
					else if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 15))
						MISC::SET_BIT(&(Global_33467[j /*23*/].f_11), 0);
					...
					if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 0) && IS_BIT_SET(Global_33467[j /*23*/].f_11, 3))
					{
						...
						if (!HUD::DOES_BLIP_EXIST(Global_33467[j /*23*/].f_19))
						{
							...
							if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_TREVOR:
										...
										{
											Global_33467[j /*23*/].f_19 = HUD::ADD_BLIP_FOR_RADIUS(Global_33467[j /*23*/][0 /*3*/], Global_33467[j /*23*/].f_10);
											HUD::SET_BLIP_ALPHA(Global_33467[j /*23*/].f_19, 128);
											HUD::SHOW_HEIGHT_ON_BLIP(Global_33467[j /*23*/].f_19, false);
										}
										else
										{
											Global_33467[j /*23*/].f_19 = HUD::ADD_BLIP_FOR_COORD(Global_33467[j /*23*/][echLocal_62 /*3*/]);
											HUD::SET_BLIP_SPRITE(Global_33467[j /*23*/].f_19, Global_33467[j /*23*/].f_12[echLocal_62]);
										}
										break;
								
									default:
										Global_33467[j /*23*/].f_19 = HUD::ADD_BLIP_FOR_COORD(1f, 2f, 3f);
										break;
								}
							}
							...
							{
								Global_33467[j /*23*/].f_19 = HUD::ADD_BLIP_FOR_COORD(Global_33467[j /*23*/][0 /*3*/]);
								HUD::SET_BLIP_SPRITE(Global_33467[j /*23*/].f_19, Global_33467[j /*23*/].f_12[0]);
							}
						...
						else
						{
							if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 19))
							{
								switch (echLocal_62)
								{
									...
									case CHAR_MICHAEL:
									case CHAR_TREVOR:
										HUD::SET_BLIP_COORDS(Global_33467[j /*23*/].f_19, Global_33467[j /*23*/][echLocal_62 /*3*/]);
										break;
							...
							{
								HUD::SET_BLIP_COORDS(Global_33467[j /*23*/].f_19, Global_33467[j /*23*/][0 /*3*/]);
							}
							...
							if (IS_BIT_SET(Global_33467[j /*23*/].f_11, 9))
							{
								if (bLocal_45)
								{
									HUD::SET_BLIP_FLASHES(Global_33467[j /*23*/].f_19, true);
									bLocal_45 = false;
								}
								else
								{
									HUD::SET_BLIP_FLASHES_ALTERNATE(Global_33467[j /*23*/].f_19, true);
									bLocal_45 = true;
								}
							
								HUD::SET_BLIP_FLASH_TIMER(Global_33467[j /*23*/].f_19, 10000);
								MISC::CLEAR_BIT(&(Global_33467[j /*23*/].f_11), 9);
							}
							else
							{
								HUD::SET_BLIP_FLASHES(Global_33467[j /*23*/].f_19, false);
							}
						}
					...
					else
					{
						if (HUD::DOES_BLIP_EXIST(Global_33467[j /*23*/].f_19))
						{
							HUD::REMOVE_BLIP(&(Global_33467[j /*23*/].f_19));
							num3 = num3 + 1;
				...
				MISC::CLEAR_BIT(&(Global_33467[j /*23*/].f_11), 18);
				num7 = 30;
...
void func_11() // Position - 0xAEE
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (uLocal_53[i] != -1)
		{
			if (HUD::DOES_BLIP_EXIST(Global_33467[uLocal_53[i] /*23*/].f_19))
			{
				distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(vector, HUD::GET_BLIP_COORDS(Global_33467[uLocal_53[i] /*23*/].f_19), true);
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (uLocal_53[i] != -1)
			if (i == num)
				if (HUD::DOES_BLIP_EXIST(Global_33467[uLocal_53[i] /*23*/].f_19))
					func_16(uLocal_53[i]);
			else if (HUD::DOES_BLIP_EXIST(Global_33467[uLocal_53[i] /*23*/].f_19))
				func_12(uLocal_53[i]);
	}
...
void func_20(Blip blParam0, int iParam1) // Position - 0xEA4
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_33467[iParam1 /*23*/].f_20)))
		if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_33467[iParam1 /*23*/].f_20)))
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blParam0, &(Global_33467[iParam1 /*23*/].f_20));
			...
			if (IS_BIT_SET(Global_33467[iParam1 /*23*/].f_11, 8))
			{
				if (!func_29(iParam1))
				{
					...
					else
					{
						...
						{
							HUD::SET_BLIP_AS_SHORT_RANGE(blParam0, IS_BIT_SET(Global_33467[iParam1 /*23*/].f_11, 5));
							HUD::SET_BLIP_PRIORITY(blParam0, 3);
							HUD::SET_BLIP_AS_SHORT_RANGE(blParam0, true);
	...
	if (IS_BIT_SET(Global_33467[iParam1 /*23*/].f_11, 19))
	{
		switch (character)
		{
			...
			case CHAR_MICHAEL:
			case CHAR_TREVOR:
				HUD::SET_BLIP_COORDS(Global_33467[iParam1 /*23*/].f_19, Global_33467[iParam1 /*23*/][character /*3*/]);
				break;
		}
	}
...
int func_22(int iParam0) // Position - 0x12AD
{
	...
	bitsInRange = MISC::GET_BITS_IN_RANGE(Global_33467[num /*23*/].f_11, 21, 26);
	return bitsInRange;
}
...
void func_46(int iParam0, BOOL bParam1) // Position - 0x1C02
{
	...
	if (bParam1)
		MISC::SET_BIT(&(Global_33467[num /*23*/].f_11), 2);
	else
		MISC::CLEAR_BIT(&(Global_33467[num /*23*/].f_11), 2);
