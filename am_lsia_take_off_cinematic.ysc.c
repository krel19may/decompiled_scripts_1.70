...
void _STOPWATCH_RESET(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x546
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(int pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x5A1
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0x644
{
	return iParam0->f_1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x134D
{
	iParam0->f_1 = 0;
	return;
}

void func_54(BOOL bParam0) // Position - 0x135A
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x21ED
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_81(Hash hParam0) // Position - 0x21FD
{
	return func_139(hParam0) && !func_82(hParam0);
}

BOOL func_82(Hash hParam0) // Position - 0x2217
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_83(Hash hParam0) // Position - 0x224C
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_84(Vehicle veParam0) // Position - 0x2353
{
	Hash entityModel;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x241F
{
	int address;
	int i;
	Player player;
...
Hash func_91(int iParam0, int iParam1) // Position - 0x255E
{
...
int func_97(Vehicle veParam0, Any* panParam1) // Position - 0x2CBD
{
...
BOOL func_98(Vehicle veParam0) // Position - 0x2D3A
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_99(Vehicle veParam0) // Position - 0x2DC7
{
	int _int;
...
BOOL func_100(var uParam0, Player plParam1) // Position - 0x2E23
{
	func_104();
...
BOOL func_101(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x30CE
{
...
int func_102(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x30F7
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_105(Vehicle veParam0) // Position - 0x8ECA
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_106(Vehicle veParam0) // Position - 0x8F02
{
	int _int;
...
BOOL func_107(Vehicle veParam0, Any* panParam1) // Position - 0x8F4A
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_108(Vehicle veParam0) // Position - 0x90A7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_109(Vehicle veParam0) // Position - 0x93E6
{
...
int func_110(Player plParam0) // Position - 0x9412
{
...
int func_111(Player plParam0) // Position - 0x942F
{
...
BOOL func_112(Player plParam0, BOOL bParam1) // Position - 0x9452
{
	if (func_11(plParam0))
...
int func_113(Player plParam0) // Position - 0x9496
{
	if (func_11(plParam0))
		if (func_112(plParam0, false))
...
BOOL func_116(Player plParam0, BOOL bParam1) // Position - 0x94E1
{
	return func_117(plParam0, bParam1, 1);
}

BOOL func_117(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x94F2
{
	Player player;
...
BOOL func_118(Player plParam0, int iParam1) // Position - 0x954E
{
	if (func_11(plParam0))
...
int func_126(Hash hParam0) // Position - 0x96D5
{
	switch (hParam0)
	{
		case 0:
...
void func_127(Vehicle veParam0, int iParam1) // Position - 0x9BF1
{
	int num;
	int num2;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA1B1
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
void func_135(Vehicle veParam0) // Position - 0xA4D3
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_136(Vehicle veParam0) // Position - 0xA505
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_137(Hash hParam0) // Position - 0xA539
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_138(Hash hParam0) // Position - 0xA556
{
...
BOOL func_139(Hash hParam0) // Position - 0xAAA7
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_140(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAB36
{
	int num;
	int num2;
	int i;
...
BOOL func_141(Vehicle veParam0, float fParam1) // Position - 0xB239
{
	float entityCoords;
	var groundZ;
...
Hash func_142(BOOL bParam0) // Position - 0xB2AA
{
	if (bParam0)
...
BOOL func_144(Player plParam0) // Position - 0xB353
{
	Player player;
...
BOOL func_145(Player plParam0) // Position - 0xB377
{
	Player player;
...
BOOL func_146(Player plParam0, int iParam1) // Position - 0xB395
{
...
BOOL func_150(Vehicle veParam0) // Position - 0xB5BD
{
	int i;
	int modType;
	Hash hashKey;
...
int func_152(Vehicle veParam0, int iParam1) // Position - 0xB6EE
{
	int value;
	int value2;
	float num;
...
int func_153(Vehicle veParam0, int iParam1) // Position - 0xB7D7
{
	int i;
...
BOOL func_154(Hash hParam0) // Position - 0xB839
{
...
BOOL func_155(Hash hParam0, int iParam1) // Position - 0xB864
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_156(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBC43
{
...
void func_158(Vehicle veParam0, int iParam1) // Position - 0xBC70
{
	int vehicleMod;
...
BOOL func_161(Vehicle veParam0) // Position - 0xBD19
{
	int _int;
...
BOOL func_165(Vehicle veParam0) // Position - 0xBE81
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xBF08
{
...
void func_171(Ped pedParam0, Any* panParam1, BOOL bParam2, int iParam3) // Position - 0xC164
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_172(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC2CD
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_173(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD5A4
{
	Hash entityModel;
	int num;
...
int func_179(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE838
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_180(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xF86A
{
	Hash entityModel;
	int num;
...
void func_188(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12B49
{
	var unk;
...
BOOL func_189(Ped pedParam0, int iParam1) // Position - 0x12DFE
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				hash = func_194(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash >= 237)
				{
					componentHash = func_190(joaat("MP_M_Freemode_01"), hash, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				hash2 = func_194(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash2 >= 256)
				{
					componentHash2 = func_190(joaat("MP_F_Freemode_01"), hash2, 11, 4);
...
Hash func_190(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x130BE
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = hParam1 - func_193(hParam0);
	...
	else
	{
		...
		componentId2 = hParam1 - func_191(hParam0, func_192(iParam2));
...
int func_191(Hash hParam0, int iParam1) // Position - 0x131D8
{
	switch (hParam0)
	{
...
ePedComponentType func_192(int iParam0) // Position - 0x1357F
{
	switch (iParam0)
	{
		case 0:
...
int func_193(Hash hParam0) // Position - 0x1362F
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_194(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x13690
{
	Hash i;
	Hash j;
...
Hash func_195(Ped pedParam0, int iParam1) // Position - 0x13731
{
...
int func_196(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13791
{
	ePedComponentType componentId;
...
Hash func_197(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x137E8
{
	int pedPropIndex;
...
int func_198(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x1382F
{
	Hash entityModel;
...
int func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1392B
{
	Hash entityModel;
...
int func_200(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13A69
{
	var outfit;
	int i;
	int num;
...
int func_201(Hash hParam0) // Position - 0x13B24
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_202(ePedComponentType epctParam0) // Position - 0x13B83
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_203(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x13C09
{
	Hash entityModel;
	Hash hash;
	Hash hash2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_219(entityModel, iParam1, hParam2, -1) };
	...
	if (iParam1 == 12)
	{
		unk = { func_215(entityModel, hParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num] != -99)
			{
				if (!func_203(pedParam0, num, unk[num]))
				{
					...
					if (num == 13)
					{
						unk18 = { func_212(entityModel, unk[num]) };
							...
							if (!func_203(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79322[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_207(entityModel, hParam2, 14, j, &unk, &Global_79322[2 /*14*/]))
											{
												Global_2883588 = hash2;
												Global_2883589 = hash3;
												return false;
					...
					{
						hash = func_195(pedParam0, num);
						Global_79322[2 /*14*/] = { func_219(entityModel, num, hash, -1) };
					
						if (!func_207(entityModel, hParam2, num, hash, &unk, &Global_79322[2 /*14*/]))
						{
							Global_2883588 = hash2;
							Global_2883589 = hash3;
							return false;
	...
	{
		unk28 = { func_212(entityModel, hParam2) };
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79321 == 1)
				if (func_206(entityModel, 11, func_195(pedParam0, 11), -1))
					if (func_205(entityModel, 4, hParam2, &hash4))
						return func_203(pedParam0, 4, hash4);
				else if (func_204(entityModel, 4, hParam2, &hash4))
					return func_203(pedParam0, 4, hash4);
...
BOOL func_204(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x14065
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (hParam2 >= 256)
					{
						componentHash = func_190(hParam0, hParam2, iParam1, 4);
...
BOOL func_205(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x1410E
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_206(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x141B6
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_190(hParam0, hParam2, 11, 4);
...
BOOL func_207(Hash hParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x14209
{
	var unk;
	int i;
	...
	{
		if (func_210(hParam0, iParam2, hParam3, -1))
		{
		...
		else if (func_209(hParam0, iParam2, hParam3, -1))
		{
...
BOOL func_208(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x1480D
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_190(hParam0, hParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_190(hParam0, hParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_190(hParam0, hParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_190(hParam0, hParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_190(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_209(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14A8A
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_210(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14EAF
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_211(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x151A2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_212(Hash hParam0, int iParam1) // Position - 0x1523B
{
	int i;
	var unk;
...
void func_213(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15B6A
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_215(Hash hParam0, int iParam1) // Position - 0x15CDC
{
	int i;
	var unk;
...
void func_216(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17B24
{
	int num;
	Hash outfit;
...
void func_218(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17DBE
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_219(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x17E2F
{
	func_265();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_249(iParam1, hParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_220(iParam1, hParam2, hParam3);

	return Global_79322[0 /*14*/];
}

void func_220(int iParam0, int iParam1, Hash hParam2) // Position - 0x17E70
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_227(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19FDD
{
	int num;
	int num2;
	int num3;
...
BOOL func_228(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A01B
{
...
void func_231(int iParam0, Hash hParam1) // Position - 0x1CE13
{
	int num;
...
void func_232(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CE33
{
	int num;
	int num2;
	Hash outfit;
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1D0BA
{
	BOOL flag;
	int num;
	var unk;
...
void func_234(int iParam0, Hash hParam1) // Position - 0x1D1BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D49C
{
	BOOL flag;
	int value;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x20272
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x20377
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x20B53
{
	BOOL flag;
	int value;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x20E38
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x2245F
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x23ABE
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x23C19
{
	BOOL flag;
	int num;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x23E99
{
	BOOL flag;
	int value;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x25746
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, Hash hParam1) // Position - 0x26EAB
{
	BOOL flag;
	int value;
	var unk;
...
void func_249(int iParam0, int iParam1, Hash hParam2) // Position - 0x27D7C
{
	switch (iParam0)
	{
		case 2:
...
void func_251(int iParam0, Hash hParam1) // Position - 0x28053
{
	int num;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x28073
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x28176
{
	BOOL flag;
	int num;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x28427
{
	BOOL flag;
	int value;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2B1E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x2B307
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2BBFF
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2BEB6
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2D4F5
{
	BOOL flag;
	int value;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2EB28
{
	BOOL flag;
	int num;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2EC7F
{
	BOOL flag;
	int num;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x2EF9B
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x3148D
{
	BOOL flag;
	int value;
	var unk;
...
void func_264(int iParam0, Hash hParam1) // Position - 0x32A18
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_266(Ped pedParam0) // Position - 0x3394B
{
	int num;
...
BOOL func_274(Ped pedParam0, BOOL bParam1) // Position - 0x33AF3
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash2 = func_194(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash2 >= 241)
						{
							componentHash2 = func_190(joaat("MP_M_Freemode_01"), hash2, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num2 = func_275(joaat("MP_F_Freemode_01"), 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash3 = func_194(pedParam0, 11, PV_COMP_INVALID);
					
						if (hash3 >= 256)
						{
							componentHash3 = func_190(joaat("MP_F_Freemode_01"), hash3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num3 = func_275(joaat("MP_F_Freemode_01"), 11, func_194(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash4 = func_194(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash4 >= 136)
						{
							componentHash4 = func_190(joaat("MP_F_Freemode_01"), hash4, 8, 4);
...
int func_275(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x3432D
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_190(hParam0, hParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_190(hParam0, hParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_190(hParam0, hParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_190(hParam0, hParam2, 8, 4);
...
int func_276(int iParam0, Hash hParam1) // Position - 0x34B4D
{
...
int func_277(Ped pedParam0) // Position - 0x34B6F
{
...
BOOL func_281(Player plParam0, BOOL bParam1) // Position - 0x34C17
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_282(Player plParam0) // Position - 0x34C4F
{
	if (func_11(plParam0))
		if (func_11(Global_1887549[plParam0 /*611*/].f_10))
...
BOOL func_284(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34CA6
{
...
Hash func_294() // Position - 0x34EE8
{
