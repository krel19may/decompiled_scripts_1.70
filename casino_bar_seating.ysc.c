...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2701
{
...
BOOL func_89(Ped pedParam0) // Position - 0x2C4D
{
	int scriptTaskStatus;
...
void func_90(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C7E
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D4E
{
	Hash statName;
...
BOOL func_93(Player plParam0) // Position - 0x2DC2
{
...
BOOL func_95(Player plParam0, int iParam1) // Position - 0x2E0F
{
	BOOL flag;
...
BOOL func_98(Player plParam0) // Position - 0x2EB5
{
	Player player;
