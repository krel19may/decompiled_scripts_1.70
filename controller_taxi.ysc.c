					...
					if (num != 2)
					{
						if (!MISC::IS_MINIGAME_IN_PROGRESS() && !flag && !func_76(5))
						{
							...
							if (func_72())
							{
								...
								if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_VEH_HORN) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID()) && !Global_33240 && MISC::GET_GAME_TIMER() - iLocal_107 > 3000)
								{
									num2 = func_70();
...
void func_30(char* sParam0, BOOL bParam1) // Position - 0x171E
{
	int i;
	int j;
...
void func_55(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x23AB
{
