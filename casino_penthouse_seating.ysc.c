...
void func_36(Hash hParam0) // Position - 0x1767
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_37() /*5571*/].f_681.f_4245[i /*3*/] == hParam0)
		{
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x273A
{
...
BOOL func_91(Ped pedParam0) // Position - 0x2C86
{
	int scriptTaskStatus;
...
void func_92(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2CB7
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D87
{
	Hash statName;
...
BOOL func_95(Player plParam0) // Position - 0x2DFB
{
...
BOOL func_97(Player plParam0, int iParam1) // Position - 0x2E48
{
	BOOL flag;
...
BOOL func_100(Player plParam0) // Position - 0x2EEE
{
	Player player;
...
Player func_113() // Position - 0x3869
{
	Player player;
