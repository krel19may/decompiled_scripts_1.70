...
void func_1(eCharacter echParam0, int iParam1) // Position - 0x321
{
	Global_79786 = echParam0;
	Global_79786.f_1 = iParam1;

	if (iParam1 == 7)
		if (echParam0 >= CHAR_MICHAEL && echParam0 < CHAR_MRS_THORNHILL)
			Global_113222[echParam0 /*10*/].f_3 = 1;
...
{
	if (Global_114135.f_9089.f_330[24 /*6*/] == true || Global_114135.f_9089.f_330[25 /*6*/] == true || Global_114135.f_9089.f_330[26 /*6*/] == true || Global_114135.f_9089.f_330[27 /*6*/] == true)
		return 1;
