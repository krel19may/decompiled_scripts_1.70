...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, ePedComponentType epctParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8F83
{
	int num;
...
int func_118(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x98F6
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_119(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9AA3
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_121(Hash hParam0) // Position - 0x9B2F
{
	hParam0->f_65 = 0;
...
void func_124(int iParam0, Hash hParam1) // Position - 0x9CAD
{
...
int func_125(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9CC1
{
	int i;
...
int func_128(Player plParam0) // Position - 0x9EA2
{
	var address;
...
Hash func_139(int iParam0, int iParam1) // Position - 0xAAE8
{
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xAD20
{
	if (iParam1 == -1)
		iParam1 = func_10();
...
void func_160(Hash hParam0, int iParam1) // Position - 0xB100
{
	int outValue;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xB328
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB365
{
...
Hash func_169(eCharacter echParam0) // Position - 0xB38A
{
...
int func_172(Player plParam0) // Position - 0xB42D
{
	int num;
...
int func_173(Player plParam0) // Position - 0xB43F
{
	if (plParam0 > -1)
		if (plParam0 == PLAYER::PLAYER_ID())
...
BOOL func_174(Player plParam0) // Position - 0xB482
{
	if (!func_11(plParam0))
		return false;
...
void func_175(Vehicle veParam0) // Position - 0xB4A1
{
	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		return;
...
int func_176(Vehicle veParam0, var uParam1, int iParam2) // Position - 0xB4F4
{
	Ped pedInVehicleSeat;
	int taskSequenceId;
...
void func_178(Vehicle veParam0, var uParam1, float fParam2, float fParam3) // Position - 0xB681
{
	Vector3 vector;
	float heading;
	Ped pedInVehicleSeat;
...
Vector3 func_179(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xB756
{
	var groundZ;
...
void func_191(var uParam0, const char* sParam1) // Position - 0xC181
{
...
int func_196(var uParam0, int iParam1, int iParam2, const char* sParam3, const char* sParam4) // Position - 0xC64D
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, const char* sParam1) // Position - 0xC768
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_212(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCB5F
{
	float distanceBetweenCoords;
	float num;
	Vector3 vector;
...
float func_213(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCC0B
{
...
int func_216(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCE1F
{
	int i;
	int j;
	int k;
...
BOOL func_217(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0xD630
{
	int num;
...
int func_218(Hash hParam0) // Position - 0xD6D1
{
	switch (hParam0)
	{
...
void func_219(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xD70C
{
	Hash hash;
	int num;
...
BOOL func_220(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD796
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_221(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD874
{
	Global_79322[1 /*14*/] = { func_264(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_222(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0xD89C
{
	var unk;
	int i;
...
BOOL func_223(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xDEA0
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_224(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xDF39
{
	int num;
...
Hash func_225(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xDFE4
{
	Hash i;
	Hash j;
...
ePedComponentType func_226(int iParam0) // Position - 0xE085
{
	switch (iParam0)
	{
		case 0:
...
int func_227(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0xE135
{
	int num;
...
Hash func_228(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0xE43C
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_229(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0xEFEF
{
	int num;
...
Hash func_230(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0xF2D3
{
	int num;
...
Hash func_231(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF59A
{
	Hash i;
	Hash hash;
...
BOOL func_232(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xF5D1
{
	Hash hash;
...
BOOL func_233(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xF5FA
{
	*uParam2 = -99;
...
int func_234(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0xF8C4
{
	int num;
...
Hash func_235(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0xFB4E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_236(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0xFCA5
{
	Hash hash;
...
BOOL func_237(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xFD3F
{
	switch (hParam0)
	{
...
Hash func_238(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xFE0D
{
	var outProp;
	int componentId;
	int num;
...
int func_239(Hash hParam0, int iParam1) // Position - 0xFF27
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<14> func_264(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x1799F
{
	func_327();
...
BOOL func_271(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19CF7
{
	int num;
	int num2;
	int num3;
...
void func_273(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x19E09
{
	int num;
	int num2;
	Hash outfit;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2DA2C
{
	switch (func_22())
	{
		case 0:
...
Hash func_384() // Position - 0x2DA5F
{
...
BOOL IS_XBOX_PLATFORM() // Position - 0x2DB64
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2DB7A
{
...
BOOL func_395() // Position - 0x2DC46
{
