...
ePedComponentType func_77(ePedComponentType epctParam0) // Position - 0x9A2B
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9ADB
{
	int i;
	var unk;
...
struct<17> func_81(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA57C
{
	int i;
	var unk;
...
void func_84(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC6C6
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_85(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC737
{
	func_149();
...
BOOL func_92(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xEA8D
{
	int num;
	int num2;
	int num3;
...
void func_234(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28464
{
...
int func_309(Ped pedParam0, eCharacter echParam1) // Position - 0x2B4F3
{
	int num;
...
int func_332(const char* sParam0) // Position - 0x2BC0C
{
...
int func_334(const char* sParam0, BOOL bParam1) // Position - 0x2BC86
{
	Hash hashKey;
	int num;
