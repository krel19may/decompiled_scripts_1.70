...
BOOL func_24(ePedComponentType epctParam0, int iParam1) // Position - 0x3CAD
{
	BOOL flag;
...
BOOL func_27(ePedComponentType epctParam0) // Position - 0x3D53
{
	Player player;
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3D75
{
	ePedComponentType type;
...
ePedComponentType func_55(Player plParam0) // Position - 0xAEF7
{
	if (func_27(plParam0))
		if (func_54(plParam0, false))
...
BOOL func_60(ePedComponentType epctParam0, int iParam1) // Position - 0xAFAF
{
	if (func_27(epctParam0))
...
BOOL func_66(ePedComponentType epctParam0) // Position - 0xB0BA
{
...
BOOL func_67(ePedComponentType epctParam0) // Position - 0xB0EF
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
int func_68(ePedComponentType epctParam0) // Position - 0xB136
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0xCDE1
{
	ePedComponentType type;
...
BOOL func_87(ePedComponentType epctParam0) // Position - 0xCE05
{
	ePedComponentType type;
...
BOOL func_88(ePedComponentType epctParam0, int iParam1) // Position - 0xCE23
{
...
ePedComponentType func_95(Vehicle veParam0, int iParam1) // Position - 0xD267
{
	ePedComponentType i;
