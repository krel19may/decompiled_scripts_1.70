...
BOOL _STOPWATCH_HAS_TIME_PASSED(int pStopwatch, Hash millis, BOOL useLocalTimer) // Position - 0x1B2
{
	if (millis == -1)
		return 1;
...
BOOL func_12(Hash hParam0) // Position - 0x5B2
{
	int num;

	if (!func_197(PLAYER::PLAYER_ID(), hParam0, false))
	{
		num = func_21(PLAYER::PLAYER_ID(), hParam0, false);
...
int func_21(Player plParam0, Hash hParam1, BOOL bParam2) // Position - 0x7FD
{
	Hash hash;
	int num;

	if (!func_59(func_169(hParam1, -1, -1, -1), func_122(hParam1, -1, 1, -1, -1, plParam0), func_68(hParam1, -1, -1, -1, -1, plParam0), false, true))
		return 0;
	...
	if (func_57(hParam1) >= func_56(hash))
		return 5;
	...
	if (func_44(hParam1) == 1)
	{
		if (func_43() || func_42() || !bParam2 && func_41() != 0 && func_44(hParam1) == 1)
			return 2;
	}
	else if (func_44(hParam1) == 2)
	{
		if (!func_38(hParam1))
			return 3;
	...
	if (func_32(plParam0) + 1 < func_26(hash))
		return 4;
...
int func_26(Hash hParam0) // Position - 0xAE3
{
	switch (hParam0)
	{
		case 180:
...
BOOL func_31(Hash hParam0) // Position - 0xC56
{
	switch (hParam0)
	{
		case 167:
...
BOOL func_34(Hash hParam0) // Position - 0xCC5
{
	switch (hParam0)
	{
		case 155:
	...
	return func_35(hParam0, 0);
}

BOOL func_35(Hash hParam0, int iParam1) // Position - 0xD1F
{
	switch (hParam0)
	{
		case 199:
...
BOOL func_38(Hash hParam0) // Position - 0xDED
{
	switch (hParam0)
	{
		case 179:
...
int func_44(Hash hParam0) // Position - 0xEEB
{
	switch (hParam0)
	{
		case 153:
...
int func_51(Hash hParam0) // Position - 0x13B3
{
	switch (hParam0)
	{
		case 0:
...
int func_57(Hash hParam0) // Position - 0x1B35
{
	return Global_1916957.f_11.f_147[func_58(hParam0)];
}
...
BOOL func_197(Player plParam0, Hash hParam1, BOOL bParam2) // Position - 0x8CFA
{
	return func_21(plParam0, hParam1, bParam2) == -1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x8D5D
{
	iParam0->f_1 = 0;
	return;
}
...
void func_229(int iParam0, Hash hParam1, int iParam2) // Position - 0x9825
{
	if (hParam1 != -1)
		func_249(hParam1);
...
void func_231(int iParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5) // Position - 0x98B4
{
	Hash eventData;
...
void func_249(Hash hParam0) // Position - 0x9BE2
{
...
void func_257(Hash hParam0) // Position - 0x9DCA
{
...
void func_262(Hash hParam0) // Position - 0x9EA7
{
	hParam0->f_65 = 0;
...
int func_269(Hash hParam0, Hash hParam1, int iParam2) // Position - 0xA23C
{
...
int func_285(Hash hParam0) // Position - 0xB02C
{
	return hParam0 / 1000;
}

int func_286(int iParam0, var uParam1, Hash hParam2) // Position - 0xB03A
{
	int num;

	num = hParam2 - MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), iParam0));
	num = num / 1000;
	return num;
}
...
const char* func_307(char* sParam0) // Position - 0xB61F
{
	return sParam0;
}
...
int func_316(Hash hParam0) // Position - 0xB847
{
	switch (hParam0)
	{
		case 1:
...
Hash func_352(int iParam0) // Position - 0xCE34
{
	switch (iParam0)
	{
		case joaat("sm_prop_smug_crate_l_medical"):
...
void func_373(int iParam0, int iParam1, int iParam2) // Position - 0xD727
{
...
void _DISPLAY_HELP_TEXT_0(const char* text, Hash hParam1) // Position - 0xE2DA
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(text);
...
void func_412() // Position - 0xE459
{
	...
	{
		_DISPLAY_HELP_TEXT_0(&unk, hLocal_537);
	...
	else if (IS_BIT_SET(iLocal_534, 7))
	{
		...
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_573, hLocal_537, false))
		{
...
Hash func_414(int iParam0) // Position - 0xE595
{
	switch (iParam0)
	{
		case 0:
...
void func_439(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF1A6
{
...
void func_441() // Position - 0xF236
{
	...
	else if (IS_BIT_SET(iLocal_534, 4))
	{
		...
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_569, hLocal_537, false))
		{
...
void func_452(BOOL bParam0) // Position - 0xF603
{
