...
void func_16(eCharacter echParam0, char* sParam1, BOOL bParam2, int iParam3) // Position - 0xF7F
{
	eCharacter character;
...
int func_21(Player plParam0) // Position - 0x10AE
{
...
ePedComponentType func_51(Ped pedParam0, int iParam1) // Position - 0x2433
{
...
BOOL func_53(Hash hParam0, int iParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x24EA
{
	var unk;
	int i;
...
BOOL func_54(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x2AEE
{
	switch (hParam0)
	{
...
Hash func_55(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x2D6B
{
	var outProp;
	int componentId;
	int num;
...
BOOL func_58(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x328D
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_59(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x36B2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_60(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x39A5
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<17> func_66(Hash hParam0, ePedComponentType epctParam1) // Position - 0x45FA
{
	int i;
	var unk;
...
void func_69(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x66DC
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_70(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x674D
{
	func_139();
...
int func_140(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3, int iParam4) // Position - 0x1DB9F
{
	int num;
	int i;
	int j;
...
int func_141(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x1DF81
{
	Global_79322[1 /*14*/] = { func_70(hParam0, iParam1, epctParam2, -1) };
...
void func_164(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11, const char* sParam12, const char* sParam13) // Position - 0x1ECDA
{
	eCharacter character;
	BOOL flag;
	var txdName;
...
void func_185(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x204AB
{
