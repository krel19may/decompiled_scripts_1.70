...
void _STOPWATCH_RESET(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x53F
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(int pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x59A
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0x63D
{
	return iParam0->f_1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x1346
{
	iParam0->f_1 = 0;
	return;
}

void func_54(BOOL bParam0) // Position - 0x1353
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x22BD
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_83(Hash hParam0) // Position - 0x22CD
{
	return func_141(hParam0) && !func_84(hParam0);
}

BOOL func_84(Hash hParam0) // Position - 0x22E7
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_85(Hash hParam0) // Position - 0x231C
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_86(Vehicle veParam0) // Position - 0x2423
{
	Hash entityModel;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x24EF
{
	int address;
	int i;
	Player player;
...
Hash func_93(int iParam0, int iParam1) // Position - 0x262E
{
...
int func_99(Vehicle veParam0, Any* panParam1) // Position - 0x2D8D
{
...
BOOL func_100(Vehicle veParam0) // Position - 0x2E0A
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_101(Vehicle veParam0) // Position - 0x2E97
{
	int _int;
...
BOOL func_102(var uParam0, Player plParam1) // Position - 0x2EF3
{
	func_106();
	...
	{
		if (func_103(uParam0, plParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1943806.f_23 == 0 && func_103(uParam0, plParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13) || Global_1943806.f_23 != 0 && Global_1943806.f_24 == 0 && func_103(uParam0, plParam1, Global_1943806, Global_1943806.f_14, Global_1943806.f_17, Global_1943806.f_20, Global_1943806.f_10, 1, Global_1943806.f_13) || Global_1943806.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577965 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_103(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x319E
{
...
int func_104(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x31C7
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_107(Vehicle veParam0) // Position - 0x8F9F
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_108(Vehicle veParam0) // Position - 0x8FD7
{
	int _int;
...
BOOL func_109(Vehicle veParam0, Any* panParam1) // Position - 0x901F
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_110(Vehicle veParam0) // Position - 0x917C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_111(Vehicle veParam0) // Position - 0x94BB
{
...
int func_112(Player plParam0) // Position - 0x94E7
{
...
int func_113(Player plParam0) // Position - 0x9504
{
...
BOOL func_114(Player plParam0, BOOL bParam1) // Position - 0x9527
{
	if (func_11(plParam0))
...
int func_115(Player plParam0) // Position - 0x956B
{
	if (func_11(plParam0))
		if (func_114(plParam0, false))
...
BOOL func_118(Player plParam0, BOOL bParam1) // Position - 0x95B6
{
	return func_119(plParam0, bParam1, 1);
}

BOOL func_119(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x95C7
{
	Player player;
...
BOOL func_120(Player plParam0, int iParam1) // Position - 0x9623
{
	if (func_11(plParam0))
...
int func_128(Hash hParam0) // Position - 0x97AA
{
	switch (hParam0)
	{
		case 0:
...
void func_129(Vehicle veParam0, int iParam1) // Position - 0x9CC6
{
	int num;
	int num2;
...
BOOL func_135(Vehicle veParam0) // Position - 0xA286
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
void func_137(Vehicle veParam0) // Position - 0xA5A8
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_138(Vehicle veParam0) // Position - 0xA5DA
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_139(Hash hParam0) // Position - 0xA60E
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_140(Hash hParam0) // Position - 0xA62B
{
...
BOOL func_141(Hash hParam0) // Position - 0xAB7C
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_142(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAC0B
{
	int num;
	int num2;
	int i;
...
BOOL func_143(Vehicle veParam0, float fParam1) // Position - 0xB30E
{
	float entityCoords;
	var groundZ;
...
Hash func_144(BOOL bParam0) // Position - 0xB37F
{
	if (bParam0)
...
BOOL func_146(Player plParam0) // Position - 0xB428
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB44C
{
	Player player;
...
BOOL func_148(Player plParam0, int iParam1) // Position - 0xB46A
{
...
BOOL func_152(Vehicle veParam0) // Position - 0xB692
{
	int i;
	int modType;
	Hash hashKey;
...
int func_154(Vehicle veParam0, int iParam1) // Position - 0xB7C3
{
	int value;
	int value2;
	float num;
...
int func_155(Vehicle veParam0, int iParam1) // Position - 0xB8AC
{
	int i;
...
BOOL func_156(Hash hParam0) // Position - 0xB90E
{
...
BOOL func_157(Hash hParam0, int iParam1) // Position - 0xB939
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_158(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBD18
{
...
void func_160(Vehicle veParam0, int iParam1) // Position - 0xBD45
{
	int vehicleMod;
...
BOOL func_163(Vehicle veParam0) // Position - 0xBDEE
{
	int _int;
...
BOOL func_167(Vehicle veParam0) // Position - 0xBF56
{
...
BOOL func_168(Player plParam0, int iParam1) // Position - 0xBFDD
{
...
void func_173(Ped pedParam0, Any* panParam1, BOOL bParam2, int iParam3) // Position - 0xC23A
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_174(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC3A3
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_175(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD67A
{
	Hash entityModel;
	int num;
...
int func_181(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE912
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_182(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xF944
{
	Hash entityModel;
	int num;
	...
	switch (iParam2)
	{
		...
		case 4:
			switch (iParam1)
			{
				...
				case 39:
					func_190(sParam0, iParam1, pedParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND(SYSTEM::TO_FLOAT(&func_24) * Global_262145.f_2877), 2);
					break;
...
void func_190(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12C24
{
	var unk;
...
BOOL func_191(Ped pedParam0, int iParam1) // Position - 0x12ED9
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				hash = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash >= 237)
				{
					componentHash = func_192(joaat("MP_M_Freemode_01"), hash, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				hash2 = func_196(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash2 >= 256)
				{
					componentHash2 = func_192(joaat("MP_F_Freemode_01"), hash2, 11, 4);
...
Hash func_192(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13199
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = hParam1 - func_195(hParam0);
	...
	else
	{
		...
		componentId2 = hParam1 - func_193(hParam0, func_194(iParam2));
...
int func_193(Hash hParam0, int iParam1) // Position - 0x132B3
{
	switch (hParam0)
	{
...
ePedComponentType func_194(int iParam0) // Position - 0x1365A
{
	switch (iParam0)
	{
		case 0:
...
int func_195(Hash hParam0) // Position - 0x1370A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_196(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1376B
{
	Hash i;
	Hash j;
...
Hash func_197(Ped pedParam0, int iParam1) // Position - 0x1380C
{
...
int func_198(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1386C
{
	ePedComponentType componentId;
...
Hash func_199(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x138C3
{
	int pedPropIndex;
...
int func_200(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x1390A
{
	Hash entityModel;
...
int func_201(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13A06
{
	Hash entityModel;
...
int func_202(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13B44
{
	var outfit;
	int i;
	int num;
...
int func_203(Hash hParam0) // Position - 0x13BFF
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_204(ePedComponentType epctParam0) // Position - 0x13C5E
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_205(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x13CE4
{
	Hash entityModel;
	Hash hash;
	Hash hash2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_221(entityModel, iParam1, hParam2, -1) };
	...
	if (iParam1 == 12)
	{
		unk = { func_217(entityModel, hParam2) };
			...
			if (unk[num] != -99)
			{
				if (!func_205(pedParam0, num, unk[num]))
				{
					...
					if (num == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_205(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_79322[2 /*14*/] = { func_221(entityModel, 14, j, -1) };
								
									if (Global_79322[2 /*14*/].f_12 == i)
									{
										if (func_205(pedParam0, 14, j))
										{
											if (!func_209(entityModel, hParam2, 14, j, &unk, &Global_79322[2 /*14*/]))
											{
												Global_2883588 = hash2;
												Global_2883589 = hash3;
												return false;
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_221(entityModel, num, hash, -1) };
					
						if (!func_209(entityModel, hParam2, num, hash, &unk, &Global_79322[2 /*14*/]))
						{
							Global_2883588 = hash2;
							Global_2883589 = hash3;
							return false;
		...
		{
			if (func_92(1759, Global_79319) != unk[10])
			{
				Global_2883588 = hash2;
				Global_2883589 = hash3;
				return false;
	...
	{
		unk28 = { func_214(entityModel, hParam2) };
	...
	{
		if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_194(iParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_194(iParam1)))
			return true;
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79321 == 1)
				if (func_208(entityModel, 11, func_197(pedParam0, 11), -1))
					if (func_207(entityModel, 4, hParam2, &hash4))
						return func_205(pedParam0, 4, hash4);
				else if (func_206(entityModel, 4, hParam2, &hash4))
					return func_205(pedParam0, 4, hash4);
...
BOOL func_206(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x14141
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (hParam2 >= 256)
					{
						componentHash = func_192(hParam0, hParam2, iParam1, 4);
...
BOOL func_207(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x141EA
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_208(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14292
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, hParam2, 11, 4);
...
BOOL func_209(Hash hParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x142E5
{
	var unk;
	int i;
	...
	{
		if (func_212(hParam0, iParam2, hParam3, -1))
		{
		...
		else if (func_211(hParam0, iParam2, hParam3, -1))
		{
		...
		else if (func_210(hParam0, iParam2, hParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_210(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x148E9
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, hParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, hParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, hParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_192(hParam0, hParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_192(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_211(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14B66
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_212(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14F8B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_213(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1527E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_214(Hash hParam0, int iParam1) // Position - 0x15317
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15C46
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_217(Hash hParam0, int iParam1) // Position - 0x15DB8
{
	int i;
	var unk;
...
void func_218(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17C00
{
	int num;
	Hash outfit;
...
void func_220(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E9A
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_221(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x17F0B
{
	func_267();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_251(iParam1, hParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_222(iParam1, hParam2, hParam3);

	return Global_79322[0 /*14*/];
}

void func_222(int iParam0, int iParam1, Hash hParam2) // Position - 0x17F4C
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_229(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A054
{
	int num;
	int num2;
	int num3;
...
BOOL func_230(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A092
{
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1CE13
{
	int num;
...
void func_234(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CE33
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_224(&Global_79322[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_224(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_224(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_235(int iParam0, Hash hParam1) // Position - 0x1D0BA
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x1D1BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x1D49C
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x20272
{
	BOOL flag;
	int num;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x20377
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x20B53
{
	BOOL flag;
	int value;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x20E38
{
	BOOL flag;
	int value;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x2245F
{
	BOOL flag;
	int value;
	var unk;
...
void func_243(int iParam0, Hash hParam1) // Position - 0x23ABE
{
	BOOL flag;
	int num;
	var unk;
...
void func_244(int iParam0, Hash hParam1) // Position - 0x23C19
{
	BOOL flag;
	int num;
	var unk;
...
void func_245(int iParam0, Hash hParam1) // Position - 0x23E99
{
	BOOL flag;
	int value;
	var unk;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_118(PLAYER::PLAYER_ID(), true) && Global_1887549[PLAYER::PLAYER_ID() /*611*/].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash2 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash2 >= 241)
						{
							componentHash2 = func_192(joaat("MP_M_Freemode_01"), hash2, 8, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash3 = func_196(pedParam0, 11, PV_COMP_INVALID);
					
						if (hash3 >= 256)
						{
							componentHash3 = func_192(joaat("MP_F_Freemode_01"), hash3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash4 = func_196(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash4 >= 136)
						{
							componentHash4 = func_192(joaat("MP_F_Freemode_01"), hash4, 8, 4);
...
int func_277(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x3432D
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_192(hParam0, hParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_192(hParam0, hParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_192(hParam0, hParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_192(hParam0, hParam2, 8, 4);
...
{
	MISC::SET_BIT(&(Global_1673654.f_&_NETWORK_IS_PLAYER_VALID), iParam0);
...
BOOL func_306(Ped pedParam0) // Position - 0x35057
{
	int pedDrawableVariation;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x35127
{
	if (iParam2 == -1)
		iParam2 = func_10();
