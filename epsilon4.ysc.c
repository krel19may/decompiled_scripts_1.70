...
ePedComponentType func_94(ePedComponentType epctParam0) // Position - 0x9EDE
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_95(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9F8E
{
	int i;
	var unk;
...
struct<17> func_98(Hash hParam0, ePedComponentType epctParam1) // Position - 0xAA2F
{
	int i;
	var unk;
...
void func_101(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCB13
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_102(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xCB84
{
	func_166();
...
BOOL func_167(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x2025C
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x20B49
{
...
void func_328(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DCD1
{
...
int func_415(Entity eParam0, eCharacter echParam1) // Position - 0x317F5
{
	int num;
...
int func_428(const char* sParam0) // Position - 0x31DCF
{
...
int func_430(const char* sParam0, BOOL bParam1) // Position - 0x31E4D
{
	Hash hashKey;
	int num;
