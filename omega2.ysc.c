...
int func_65(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E2
{
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_118(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79322[1 /*14*/] = { func_118(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79322[1 /*14*/] = { func_118(entityModel, 14, unk18[j], -1) };
							func_85(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_108(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79322[1 /*14*/] = { func_118(entityModel, i, func_74(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79322[1 /*14*/] = { func_118(entityModel, 14, unk59[j], -1) };
			func_85(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_108(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
...
BOOL func_66(Ped pedParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x1FF3
{
	...
	{
		if (!func_182(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_64, Global_114135.f_2367.f_539[num /*65*/].f_63))
		{
...
{
	Global_79322[1 /*14*/] = { func_118(epctParam0, iParam1, epctParam2, -1) };
...
BOOL func_73(Ped pedParam0, ePedComponentType epctParam1, var uParam2, int iParam3) // Position - 0x28FC
{
	...
	{
		if (!func_182(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_61, Global_114135.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
struct<14> func_118(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC40B
{
	func_181();
...
void func_119(int iParam0, ePedComponentType epctParam1) // Position - 0xC45D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_125(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE71C
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE82E
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_121(&Global_79322[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_121(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_121(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_139(ePedComponentType epctParam0) // Position - 0x1103B
{
	if (epctParam0 < 136)
		func_141(epctParam0);
	else
...
void func_144(int iParam0, ePedComponentType epctParam1) // Position - 0x12D98
{
	switch (iParam0)
	{
		case 0:
...
void func_157(ePedComponentType epctParam0) // Position - 0x17CA9
{
	if (epctParam0 < 107)
		func_160(epctParam0);
...
void func_163(int iParam0, ePedComponentType epctParam1) // Position - 0x1A575
{
	switch (iParam0)
	{
		case 0:
...
void func_176(ePedComponentType epctParam0) // Position - 0x1E40D
{
	if (epctParam0 < 60)
		func_178(epctParam0);
	else
...
BOOL func_182(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FAAC
{
	ePedComponentType entityModel;
	ePedComponentType type;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_118(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_182(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_182(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79322[2 /*14*/] = { func_118(entityModel, 14, k, -1) };
								
									if (Global_79322[2 /*14*/].f_12 == j)
										if (func_182(pedParam0, 14, k))
											if (!func_71(entityModel, epctParam2, 14, k, &unk, &Global_79322[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_118(entityModel, i, type, -1) };
					
						if (!func_71(entityModel, epctParam2, i, type, &unk, &Global_79322[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_75(epctParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_75(epctParam1)))
	{
		return true;
	}
...
eCharacter func_187(int iParam0, BOOL bParam1) // Position - 0x1FF06
{
	eCharacter character;
	int num;
...
struct<2> func_208(eCharacter echParam0) // Position - 0x21FEF
{
	var unk;
	var unk3;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_258(Global_79795, Global_79797, iParam10) };
				y == -0.014f;
...
struct<2> func_258(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x23A30
{
	var unk;
	eCharacter character;
...
char* func_259(eCharacter echParam0) // Position - 0x23B06
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
struct<2> func_266(eCharacter echParam0) // Position - 0x23D95
{
	var unk;
...
int func_278(Ped pedParam0, eCharacter echParam1) // Position - 0x245F2
{
	int num;
...
void func_305(int iParam0) // Position - 0x251B7
{
	int i;
	int j;
...
BOOL func_315(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x25AA4
{
	ePedComponentType entityModel;
	int i;
	var unk;
	...
	{
		unk28 = { func_98(entityModel, PV_COMP_HEAD) };
		Global_79322[1 /*14*/] = { func_118(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, 0);
	}
...
void func_318(BOOL bParam0, BOOL bParam1) // Position - 0x25CF8
{
...
void func_320(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25DDF
{
	...
	if (iParam0 != -1)
	{
		...
		func_321(&unk33, unk.f_3, Global_101725, bParam1, bParam2);
	}
...
int func_362(const char* sParam0) // Position - 0x2B5E0
{
...
int func_364(const char* sParam0, BOOL bParam1) // Position - 0x2B65A
{
	Hash hashKey;
	int num;
