...
eCharacter func_28(int iParam0, BOOL bParam1) // Position - 0x138A
{
...
void func_73(var uParam0, ePedComponentType epctParam1) // Position - 0x2472
{
	var unk;
	int num;
...
void func_74(ePedComponentType epctParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4C5A
{
	var unk;
...
void func_80(var uParam0, ePedComponentType epctParam1) // Position - 0x6314
{
	var unk;
...
BOOL func_81(ePedComponentType epctParam0) // Position - 0x6A10
{
	switch (epctParam0)
	{
		case 87:
...
BOOL func_82(ePedComponentType epctParam0, int iParam1) // Position - 0x6A3F
{
	if (iParam1 == -1)
	{
		switch (epctParam0)
...
// Unhandled jump detected. Output should be considered invalid
int func_83(ePedComponentType epctParam0, int iParam1) // Position - 0x6B1C
{
	if (iParam1 == -1)
	{
		switch (epctParam0)
...
int func_84(ePedComponentType epctParam0) // Position - 0x6BD8
{
	switch (epctParam0)
	{
		case 83:
...
void func_85(ePedComponentType epctParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x6C01
{
	var unk;
	Vector3 vector;
...
struct<6> func_86(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x80B6
{
	var unk;
...
int func_87(ePedComponentType epctParam0) // Position - 0x8C6C
{
	switch (epctParam0)
	{
		case PV_COMP_BERD:
