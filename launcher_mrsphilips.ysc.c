...
ePedComponentType func_83() // Position - 0x75E2
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x7626
{
...
void func_127(Ped pedParam0) // Position - 0xAAC7
{
	int num;
	int num2;
	int num3;
...
int func_129(Ped pedParam0) // Position - 0xABA3
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAD03
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAD4C
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAD6C
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAEB0
{
	int i;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB050
{
	if (bParam0)
	{
...
BOOL func_146(Player plParam0, int iParam1) // Position - 0xB1B9
{
	BOOL flag;
...
BOOL func_148(Player plParam0) // Position - 0xB253
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB275
{
...
int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB2C2
{
	int num;
...
BOOL func_154(const char* sParam0) // Position - 0xB33F
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB472
{
...
void func_161(Vehicle veParam0) // Position - 0xB4C9
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_179(const char* sParam0, int iParam1) // Position - 0xBC9F
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_186(Vehicle veParam0) // Position - 0xC695
{
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCEC2
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD0C6
{
...
void func_206(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD4A3
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_211(Object* pobParam0) // Position - 0xDB5C
{
...
BOOL func_214(Ped pedParam0, Vehicle veParam1) // Position - 0xDDC5
{
...
BOOL func_217(Ped pedParam0, int iParam1) // Position - 0xE0E5
{
	float xSize;
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE15B
{
	return func_219(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_219(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE173
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_220(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE234
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_221(Ped pedParam0, int iParam1) // Position - 0xE360
{
...
BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE46F
{
	var unk;
...
int func_227(Ped pedParam0, Ped pedParam1) // Position - 0xE57B
{
	int i;
...
BOOL func_228(Ped pedParam0) // Position - 0xE5BA
{
...
BOOL func_229(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE5E2
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE6DD
{
	float entityCoords;
	float num;
...
BOOL func_231(Ped pedParam0, float fParam1) // Position - 0xE7E9
{
	var outProjectile;
	var outCoords;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE87E
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_233(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE90C
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_235(Vehicle veParam0) // Position - 0xE99E
{
	int taskSequenceId;
...
void func_262(Object* pobParam0, BOOL bParam1) // Position - 0xF287
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_265(Vehicle* pveParam0) // Position - 0xF311
{
...
void func_266(Vehicle* pveParam0) // Position - 0xF349
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_269(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF438
{
...
void func_270(Ped* ppedParam0) // Position - 0xF488
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
