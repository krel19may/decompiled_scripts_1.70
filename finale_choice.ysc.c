...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1181
{
	if (iParam1 == -1)
		iParam1 = func_25();
...
int func_26(eCharacter echParam0, eCharacter echParam1) // Position - 0x11A9
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1461
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x149E
{
...
Hash func_38(eCharacter echParam0) // Position - 0x14C3
{
...
void func_49(eCharacter echParam0) // Position - 0x1965
{
	eCharacter i;
	var unk;
...
void func_50(eCharacter echParam0) // Position - 0x1A1E
{
	eCharacter i;
	var unk;
...
int func_53(eCharacter echParam0) // Position - 0x1C4F
{
	eCharacter character;
...
void func_54(eCharacter echParam0, eCharacter echParam1) // Position - 0x1CA5
{
	eCharacter character;
...
void func_55(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x1CDA
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;
...
void func_56(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x1D1F
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return;
...
int func_57(eCharacter echParam0, eCharacter echParam1) // Position - 0x1D64
{
	if (echParam1 < CHAR_MICHAEL || echParam1 > CHAR_ALL_PLAYERS_CONF)
		return 0;
...
void func_58(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x1D8E
{
