...
void _STOPWATCH_RESET(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x539
{
...
BOOL _STOPWATCH_HAS_TIME_PASSED(int pStopwatch, int millis, BOOL useLocalTimer) // Position - 0x594
{
	if (millis == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0x637
{
	return iParam0->f_1;
}
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0x1340
{
	iParam0->f_1 = 0;
	return;
}

void func_54(BOOL bParam0) // Position - 0x134D
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2148
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_79(Hash hParam0) // Position - 0x2158
{
	return func_137(hParam0) && !func_80(hParam0);
}

BOOL func_80(Hash hParam0) // Position - 0x2172
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_81(Hash hParam0) // Position - 0x21A7
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_82(Vehicle veParam0) // Position - 0x22AE
{
	Hash entityModel;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x237A
{
	int address;
	int i;
	Player player;
...
Hash func_89(int iParam0, int iParam1) // Position - 0x24B9
{
...
int func_95(Vehicle veParam0, Any* panParam1) // Position - 0x2C18
{
...
BOOL func_96(Vehicle veParam0) // Position - 0x2C95
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_97(Vehicle veParam0) // Position - 0x2D22
{
	int _int;
...
BOOL func_98(var uParam0, Player plParam1) // Position - 0x2D7E
{
	func_102();
...
BOOL func_99(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x3029
{
...
int func_100(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x3052
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_103(Vehicle veParam0) // Position - 0x8E26
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_104(Vehicle veParam0) // Position - 0x8E5E
{
	int _int;
...
BOOL func_105(Vehicle veParam0, Any* panParam1) // Position - 0x8EA6
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_106(Vehicle veParam0) // Position - 0x9003
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_107(Vehicle veParam0) // Position - 0x9342
{
...
int func_108(Player plParam0) // Position - 0x936E
{
...
int func_109(Player plParam0) // Position - 0x938B
{
...
BOOL func_110(Player plParam0, BOOL bParam1) // Position - 0x93AE
{
	if (func_11(plParam0))
...
int func_111(Player plParam0) // Position - 0x93F2
{
	if (func_11(plParam0))
		if (func_110(plParam0, false))
...
BOOL func_114(Player plParam0, BOOL bParam1) // Position - 0x943D
{
	return func_115(plParam0, bParam1, 1);
}

BOOL func_115(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x944E
{
	Player player;
...
BOOL func_116(Player plParam0, int iParam1) // Position - 0x94AA
{
	if (func_11(plParam0))
...
int func_124(Hash hParam0) // Position - 0x9631
{
	switch (hParam0)
	{
		case 0:
...
void func_125(Vehicle veParam0, int iParam1) // Position - 0x9B4D
{
	int num;
	int num2;
...
BOOL func_131(Vehicle veParam0) // Position - 0xA10D
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
void func_133(Vehicle veParam0) // Position - 0xA42F
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_134(Vehicle veParam0) // Position - 0xA461
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_135(Hash hParam0) // Position - 0xA495
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_136(Hash hParam0) // Position - 0xA4B2
{
...
BOOL func_137(Hash hParam0) // Position - 0xAA03
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_138(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAA92
{
	int num;
	int num2;
	int i;
...
BOOL func_139(Vehicle veParam0, float fParam1) // Position - 0xB195
{
	float entityCoords;
	var groundZ;
...
Hash func_140(BOOL bParam0) // Position - 0xB206
{
	if (bParam0)
...
BOOL func_142(Player plParam0) // Position - 0xB2AF
{
	Player player;
...
BOOL func_143(Player plParam0) // Position - 0xB2D3
{
	Player player;
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0xB2F1
{
...
BOOL func_148(Vehicle veParam0) // Position - 0xB519
{
	int i;
	int modType;
	Hash hashKey;
...
int func_150(Vehicle veParam0, int iParam1) // Position - 0xB64A
{
	int value;
	int value2;
	float num;
...
int func_151(Vehicle veParam0, int iParam1) // Position - 0xB733
{
	int i;
...
BOOL func_152(Hash hParam0) // Position - 0xB795
{
...
BOOL func_153(Hash hParam0, int iParam1) // Position - 0xB7C0
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_154(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xBB9F
{
...
void func_156(Vehicle veParam0, int iParam1) // Position - 0xBBCC
{
	int vehicleMod;
...
BOOL func_159(Vehicle veParam0) // Position - 0xBC75
{
	int _int;
...
BOOL func_163(Vehicle veParam0) // Position - 0xBDDD
{
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xBE64
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xBEB1
{
...
void func_170(Ped pedParam0, Any* panParam1, BOOL bParam2, int iParam3) // Position - 0xC0E1
{
	var unk;
	int characterType;
	BOOL flag;
...
void func_171(Ped pedParam0, int iParam1, int iParam2) // Position - 0xC24A
{
	switch (iParam1)
	{
		case 1310977332:
...
BOOL func_172(Ped pedParam0, const char* sParam1, int iParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xD521
{
	Hash entityModel;
	int num;
...
int func_178(Hash hParam0, const char* sParam1, int iParam2) // Position - 0xE7B5
{
	switch (iParam2)
	{
		case joaat("crewLogo"):
...
BOOL func_179(char* sParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0xF7E7
{
	Hash entityModel;
	int num;
...
void func_187(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12AC7
{
	var unk;
...
BOOL func_188(Ped pedParam0, int iParam1) // Position - 0x12D7C
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			{
				hash = func_193(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash >= 237)
				{
					componentHash = func_189(joaat("MP_M_Freemode_01"), hash, 11, 3);
		...
		else if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_F_Freemode_01"))
		{
			...
			{
				hash2 = func_193(pedParam0, 11, PV_COMP_INVALID);
			
				if (hash2 >= 256)
				{
					componentHash2 = func_189(joaat("MP_F_Freemode_01"), hash2, 11, 4);
...
Hash func_189(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1303C
{
	var outProp;
	int componentId;
	int num;
	...
	else if (iParam2 == 14)
	{
		...
		componentId = hParam1 - func_192(hParam0);
	...
	else
	{
		...
		componentId2 = hParam1 - func_190(hParam0, func_191(iParam2));
...
int func_190(Hash hParam0, int iParam1) // Position - 0x13156
{
	switch (hParam0)
	{
...
ePedComponentType func_191(int iParam0) // Position - 0x134FD
{
	switch (iParam0)
	{
		case 0:
...
int func_192(Hash hParam0) // Position - 0x135AD
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_193(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x1360E
{
	Hash i;
	Hash j;
...
Hash func_194(Ped pedParam0, int iParam1) // Position - 0x136AF
{
...
int func_195(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1370F
{
	ePedComponentType componentId;
...
Hash func_196(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13766
{
	int pedPropIndex;
...
int func_197(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x137AD
{
	Hash entityModel;
...
int func_198(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x138A9
{
	Hash entityModel;
...
int func_199(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x139E7
{
	var outfit;
	int i;
	int num;
...
int func_200(Hash hParam0) // Position - 0x13AA2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_201(ePedComponentType epctParam0) // Position - 0x13B01
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_202(Ped pedParam0, int iParam1, Hash hParam2) // Position - 0x13B87
{
	Hash entityModel;
	Hash hash;
	Hash hash2;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_218(entityModel, iParam1, hParam2, -1) };
	...
	if (iParam1 == 12)
	{
		unk = { func_214(entityModel, hParam2) };
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num] != -99)
			{
				if (!func_202(pedParam0, num, unk[num]))
				{
					...
					if (num == 13)
					{
						unk18 = { func_211(entityModel, unk[num]) };
							...
							if (!func_202(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									...
									if (Global_79322[2 /*14*/].f_12 == i)
									{
										...
										{
											if (!func_206(entityModel, hParam2, 14, j, &unk, &Global_79322[2 /*14*/]))
											{
												Global_2883588 = hash2;
												Global_2883589 = hash3;
												return false;
					...
					{
						hash = func_194(pedParam0, num);
						Global_79322[2 /*14*/] = { func_218(entityModel, num, hash, -1) };
					
						if (!func_206(entityModel, hParam2, num, hash, &unk, &Global_79322[2 /*14*/]))
						{
							Global_2883588 = hash2;
							Global_2883589 = hash3;
							return false;
	...
	{
		unk28 = { func_211(entityModel, hParam2) };
		...
		if (iParam1 == 4)
		{
			...
			if (Global_79321 == 1)
				if (func_205(entityModel, 11, func_194(pedParam0, 11), -1))
					if (func_204(entityModel, 4, hParam2, &hash4))
						return func_202(pedParam0, 4, hash4);
				else if (func_203(entityModel, 4, hParam2, &hash4))
					return func_202(pedParam0, 4, hash4);
...
BOOL func_203(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x13FE2
{
	Hash componentHash;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (hParam2 >= 256)
					{
						componentHash = func_189(hParam0, hParam2, iParam1, 4);
...
BOOL func_204(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0x1408D
{
	Hash componentHash;
	int shopPedApparelVariantComponentCount;
	int i;
...
BOOL func_205(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14135
{
	switch (hParam0)
	{
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 11:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_189(hParam0, hParam2, 11, 4);
...
BOOL func_206(Hash hParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0x14188
{
	var unk;
	int i;
	...
	{
		if (func_209(hParam0, iParam2, hParam3, -1))
		{
		...
		else if (func_208(hParam0, iParam2, hParam3, -1))
		{
		...
		else if (func_207(hParam0, iParam2, hParam3, -1))
		{
			if (iParam1 == 1 || iParam1 == 2 || iParam1 == 4 || iParam1 == 5 || iParam1 == 10 || iParam1 == 11 || iParam1 == 12 || iParam1 == 14 || iParam1 == 18 || iParam1 == 50)
				return false;
...
BOOL func_207(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x1478C
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_189(hParam0, hParam2, 14, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, hParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_189(hParam0, hParam2, 1, 3);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, hParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_189(hParam0, hParam2, 14, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, hParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					...
					{
						if (hParam3 == -1)
							hParam3 = func_189(hParam0, hParam2, 1, 4);
					
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_189(hParam0, hParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
BOOL func_208(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14A09
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_209(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x14E2E
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_210(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x15121
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_211(Hash hParam0, int iParam1) // Position - 0x151BA
{
	int i;
	var unk;
...
void func_212(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15AE9
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_214(Hash hParam0, int iParam1) // Position - 0x15C5B
{
	int i;
	var unk;
...
void func_215(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x17AA3
{
	int num;
	Hash outfit;
...
void func_217(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17D3D
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = hParam3;
...
struct<14> func_218(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x17DAE
{
	func_264();

	if (hParam0 == joaat("MP_M_Freemode_01"))
		func_248(iParam1, hParam2, hParam3);
	else if (hParam0 == joaat("MP_F_Freemode_01"))
		func_219(iParam1, hParam2, hParam3);

	return Global_79322[0 /*14*/];
}

void func_219(int iParam0, int iParam1, Hash hParam2) // Position - 0x17DEF
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_226(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19EF7
{
	int num;
	int num2;
	int num3;
...
BOOL func_227(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x19F35
{
...
void func_230(int iParam0, Hash hParam1) // Position - 0x1CE13
{
	int num;
...
void func_231(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1CE33
{
	int num;
	int num2;
	Hash outfit;
...
void func_232(int iParam0, Hash hParam1) // Position - 0x1D0BA
{
	BOOL flag;
	int num;
	var unk;
...
void func_233(int iParam0, Hash hParam1) // Position - 0x1D1BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_234(int iParam0, Hash hParam1) // Position - 0x1D49C
{
	BOOL flag;
	int value;
	var unk;
...
void func_235(int iParam0, Hash hParam1) // Position - 0x20272
{
	BOOL flag;
	int num;
	var unk;
...
void func_236(int iParam0, Hash hParam1) // Position - 0x20377
{
	BOOL flag;
	int value;
	var unk;
...
void func_237(int iParam0, Hash hParam1) // Position - 0x20B53
{
	BOOL flag;
	int value;
	var unk;
...
void func_238(int iParam0, Hash hParam1) // Position - 0x20E38
{
	BOOL flag;
	int value;
	var unk;
...
void func_239(int iParam0, Hash hParam1) // Position - 0x2245F
{
	BOOL flag;
	int value;
	var unk;
...
void func_240(int iParam0, Hash hParam1) // Position - 0x23ABE
{
	BOOL flag;
	int num;
	var unk;
...
void func_241(int iParam0, Hash hParam1) // Position - 0x23C19
{
	BOOL flag;
	int num;
	var unk;
...
void func_242(int iParam0, Hash hParam1) // Position - 0x23E99
{
	BOOL flag;
	int value;
	var unk;
...
void func_246(int iParam0, Hash hParam1) // Position - 0x25746
{
	BOOL flag;
	int value;
	var unk;
...
void func_247(int iParam0, Hash hParam1) // Position - 0x26EAB
{
	BOOL flag;
	int value;
	var unk;
...
void func_248(int iParam0, int iParam1, Hash hParam2) // Position - 0x27D7C
{
	switch (iParam0)
	{
		case 2:
...
void func_250(int iParam0, Hash hParam1) // Position - 0x28053
{
	int num;
...
void func_251(int iParam0, Hash hParam1) // Position - 0x28073
{
	BOOL flag;
	int num;
	var unk;
...
void func_252(int iParam0, Hash hParam1) // Position - 0x28176
{
	BOOL flag;
	int num;
	var unk;
...
void func_253(int iParam0, Hash hParam1) // Position - 0x28427
{
	BOOL flag;
	int value;
	var unk;
...
void func_254(int iParam0, Hash hParam1) // Position - 0x2B1E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_255(int iParam0, Hash hParam1) // Position - 0x2B307
{
	BOOL flag;
	int value;
	var unk;
...
void func_256(int iParam0, Hash hParam1) // Position - 0x2BBFF
{
	BOOL flag;
	int value;
	var unk;
...
void func_257(int iParam0, Hash hParam1) // Position - 0x2BEB6
{
	BOOL flag;
	int value;
	var unk;
...
void func_258(int iParam0, Hash hParam1) // Position - 0x2D4F5
{
	BOOL flag;
	int value;
	var unk;
...
void func_259(int iParam0, Hash hParam1) // Position - 0x2EB28
{
	BOOL flag;
	int num;
	var unk;
...
void func_260(int iParam0, Hash hParam1) // Position - 0x2EC7F
{
	BOOL flag;
	int num;
	var unk;
...
void func_261(int iParam0, Hash hParam1) // Position - 0x2EF9B
{
	BOOL flag;
	int value;
	var unk;
...
void func_262(int iParam0, Hash hParam1) // Position - 0x3148D
{
	BOOL flag;
	int value;
	var unk;
...
void func_263(int iParam0, Hash hParam1) // Position - 0x32A18
{
	BOOL flag;
	int value;
	var unk;
...
BOOL func_265(Ped pedParam0) // Position - 0x3394B
{
	int num;
...
BOOL func_273(Ped pedParam0, BOOL bParam1) // Position - 0x33AF3
{
	int pedDrawableVariation;
	int pedTextureVariation;
	int num;
		...
		if (ENTITY::GET_ENTITY_MODEL(pedParam0) == joaat("MP_M_Freemode_01"))
		{
			...
			switch (pedDrawableVariation)
			{
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash2 = func_193(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash2 >= 241)
						{
							componentHash2 = func_189(joaat("MP_M_Freemode_01"), hash2, 8, 3);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num2 = func_274(joaat("MP_F_Freemode_01"), 11, func_193(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash3 = func_193(pedParam0, 11, PV_COMP_INVALID);
					
						if (hash3 >= 256)
						{
							componentHash3 = func_189(joaat("MP_F_Freemode_01"), hash3, 11, 4);
			...
			switch (pedDrawableVariation)
			{
				case 0:
					switch (pedTextureVariation)
					{
						...
						case 4:
						case 9:
							num3 = func_274(joaat("MP_F_Freemode_01"), 11, func_193(pedParam0, 11, PV_COMP_INVALID), 0);
				...
				default:
					if (pedDrawableVariation > 15)
					{
						hash4 = func_193(pedParam0, 8, PV_COMP_INVALID);
					
						if (hash4 >= 136)
						{
							componentHash4 = func_189(joaat("MP_F_Freemode_01"), hash4, 8, 4);
...
int func_274(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x3432D
{
	Hash componentHash;
	...
	if (hParam0 == joaat("MP_M_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash = func_189(hParam0, hParam2, 11, 3);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash2 = func_189(hParam0, hParam2, 8, 3);
	...
	else if (hParam0 == joaat("MP_F_Freemode_01"))
	{
		if (iParam1 == 11)
		{
			...
			{
				componentHash3 = func_189(hParam0, hParam2, 11, 4);
		...
		else if (iParam1 == 8)
		{
			...
			{
				componentHash4 = func_189(hParam0, hParam2, 8, 4);
...
int func_275(int iParam0, Hash hParam1) // Position - 0x34B4D
{
...
int func_276(Ped pedParam0) // Position - 0x34B6F
{
...
BOOL func_280(Player plParam0, BOOL bParam1) // Position - 0x34C17
{
	if (!func_11(plParam0))
		return false;
...
BOOL func_281(Player plParam0) // Position - 0x34C4F
{
	if (func_11(plParam0))
		if (func_11(Global_1887549[plParam0 /*611*/].f_10))
...
BOOL func_283(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x34CA6
{
...
Hash func_293() // Position - 0x34EE8
{
