...
void func_40(eCharacter echParam0, int iParam1) // Position - 0x1A74
{
	int num;
...
void func_41(eCharacter echParam0) // Position - 0x1B61
{
...
void func_42(eCharacter echParam0) // Position - 0x1BAC
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_51(eCharacter echParam0) // Position - 0x24AC
{
	Hash entityModel;
