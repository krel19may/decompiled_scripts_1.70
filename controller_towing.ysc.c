...
int func_99(Player plParam0) // Position - 0x8A8C
{
...
BOOL func_132(Player plParam0) // Position - 0x9AC6
{
	return func_133(plParam0, 20);
}

BOOL func_133(Player plParam0, int iParam1) // Position - 0x9AD6
{
...
void func_142(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x9DFC
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x9E52
{
...
float func_144(int* piParam0) // Position - 0x9EED
{
...
BOOL func_146(int* piParam0) // Position - 0x9F81
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_147(int* piParam0) // Position - 0x9F8E
{
	func_148(piParam0, 0f);
	return;
}

void func_148(int* piParam0, float fParam1) // Position - 0x9F9D
{
...
BOOL func_149(int* piParam0) // Position - 0x9FC8
{
...
BOOL func_151(Ped pedParam0) // Position - 0x9FF7
{
...
void func_154(var uParam0, Ped pedParam1) // Position - 0xA09C
{
	if (!func_158(uParam0, false, true))
	{
		if (func_151(pedParam1))
...
void func_155(int* piParam0) // Position - 0xA1A2
{
	if (!func_149(piParam0))
		func_147(piParam0);
...
void func_156(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xA1BA
{
	float num;
	Vehicle vehiclePedIsIn;
	Hash entityModel;
...
eCharacter func_161(int iParam0) // Position - 0xA56B
{
