...
struct<10> func_77(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9786
{
	int i;
	var unk;
...
struct<17> func_80(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA227
{
	int i;
	var unk;
...
struct<14> func_84(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC37D
{
	func_148();
...
BOOL func_149(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FA26
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
void func_275(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2A1C5
{
...
int func_313(Entity eParam0, eCharacter echParam1) // Position - 0x2B4B1
{
	int num;
...
int func_337(const char* sParam0) // Position - 0x2BC0F
{
...
int func_339(const char* sParam0, BOOL bParam1) // Position - 0x2BC89
{
	Hash hashKey;
	int num;
