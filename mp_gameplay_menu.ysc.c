...
void func_7(int* piParam0) // Position - 0x6E7
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_8(var uParam0, BOOL bParam1, int iParam2) // Position - 0x713
{
	var unk;
	Hash hashKey;
	int i;
...
void func_10(var uParam0, char* sParam1) // Position - 0x7BF
{
...
void func_22(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xAE7
{
	int i;
...
BOOL func_29(var uParam0) // Position - 0xF05
{
...
BOOL func_31(var uParam0, char* sParam1) // Position - 0xF2D
{
...
void func_33(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0xF8F
{
	int num;
...
void func_36(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x146A
{
...
BOOL func_39(BOOL bParam0, BOOL bParam1) // Position - 0x156A
{
...
eTransitionState func_40() // Position - 0x1607
{
	return Global_1575012;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x1613
{
	switch (iParam0)
	{
		case 5:
...
void func_42(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x164B
{
	int num;
	int r;
	int g;
...
BOOL func_48(int iParam0) // Position - 0x4958
{
	if (iParam0 == 1)
...
void func_52(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x4A4C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x4A6A
{
...
void func_57(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x4EF9
{
	int num;
	int i;
	int j;
...
BOOL func_58(Player plParam0, int iParam1) // Position - 0x53F7
{
	BOOL flag;
...
BOOL func_61(Player plParam0) // Position - 0x549D
{
	Player player;
...
void func_64(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x5547
{
...
void func_66(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x56C7
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(epctParam3);
...
float func_67(char* sParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x56EA
{
...
char* func_69(int iParam0, BOOL bParam1) // Position - 0x57B6
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_70(const char* sParam0) // Position - 0x5CDE
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x5CE8
{
	var gamerHandle;
...
void func_73(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x5D72
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_75(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x5E15
{
	var textureDict;
	var textureName;
	int num;
...
void func_80(ePedComponentType epctParam0, int iParam1, BOOL bParam2) // Position - 0x6093
{
	int num;
	float num2;
	float num3;
...
BOOL func_81(ePedComponentType epctParam0) // Position - 0x620E
{
	return func_82(&(hLocal_843.f_2), epctParam0);
}

BOOL func_82(var uParam0, ePedComponentType epctParam1) // Position - 0x6221
{
	return IS_BIT_SET(uParam0->[epctParam1 / 32], epctParam1 & 31);
}

void func_83(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6238
{
	int num;
	float num2;
	float num3;
...
void func_86(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x64AD
{
	int num;
...
BOOL func_87(ePedComponentType epctParam0) // Position - 0x64F9
{
...
BOOL func_88(var uParam0, ePedComponentType epctParam1) // Position - 0x6531
{
	return !IS_BIT_SET(uParam0->f_104[epctParam1], 1);
}

void func_89(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6544
{
...
void func_99(ePedComponentType epctParam0) // Position - 0x67E9
{
	func_100(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_100(var uParam0, ePedComponentType epctParam1) // Position - 0x67FC
{
	MISC::SET_BIT(&uParam0->[epctParam1 / 32], epctParam1 & 31);
	return;
}

void func_101(ePedComponentType epctParam0) // Position - 0x6816
{
	func_102(&(hLocal_843.f_2), epctParam0);
	return;
}

void func_102(var uParam0, ePedComponentType epctParam1) // Position - 0x6829
{
...
BOOL func_109(int* piParam0) // Position - 0x6DD6
{
	switch (piParam0->f_9)
	{
		case 0:
