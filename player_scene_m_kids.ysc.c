			...
			case 1:
				if (uLocal_248[iParam1] != Global_96669[uLocal_245[iParam1]])
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Global_101409))
					{
						...
						Global_101409 = pedParam0;
						return;
					}
				
					ENTITY::DOES_ENTITY_EXIST(Global_101409);
				}
				else
				{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98993))
		{
			for (i = 0; i < iLocal_236; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_236[i]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_98993, &uLocal_348, &uLocal_429[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
					uLocal_242[i] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[i], false))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_98993, &uLocal_301[i /*16*/], &uLocal_348, 8f, 1090519040, 0, 1148846080);
				}
			}
...
BOOL func_36() // Position - 0x4AD5
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98992))
	{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_236[i]))
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_98992, &uLocal_348, &uLocal_396[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[i], false))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_268[i /*16*/]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_98992, &uLocal_268[i /*16*/], &uLocal_348, 8f, 1090519040, 0, 1148846080);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_252[i]))
...
int func_38(int iParam0, Ped pedParam1) // Position - 0x4D8C
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_39(Global_101409) && pedParam1 != 0)
		{
			Global_101409 = 0;
		}
	}
...
Ped func_39(Ped pedParam0) // Position - 0x4E70
{
	return pedParam0;
}
...
BOOL func_49(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x5D39
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_70(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_49(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_79322[2 /*14*/].f_12 == j)
										if (func_49(pedParam0, 14, k))
											if (!func_53(entityModel, epctParam2, 14, k, &unk, &Global_79322[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						if (!func_53(entityModel, epctParam2, i, type, &unk, &Global_79322[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_50(epctParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_50(epctParam1)))
	{
		return true;
	}
...
ePedComponentType func_51(Ped pedParam0, int iParam1) // Position - 0x6042
{
...
BOOL func_53(ePedComponentType epctParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x60F9
{
	var unk;
	int i;
...
BOOL func_54(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x66FD
{
	switch (epctParam0)
	{
...
Hash func_55(ePedComponentType epctParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x697A
{
	var outProp;
	int componentId;
	int num;
...
int func_56(ePedComponentType epctParam0, ePedComponentType epctParam1) // Position - 0x6A94
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
int func_57(ePedComponentType epctParam0) // Position - 0x6E3B
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_58(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x6E9C
{
	if (epctParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_59(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x72C1
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_60(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x75B4
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
struct<10> func_61(ePedComponentType epctParam0, ePedComponentType epctParam1) // Position - 0x764D
{
	int i;
	var unk;
...
void func_62(var uParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x7F7C
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
int func_63(ePedComponentType epctParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x80A7
{
	var outfit;
	int i;
	int num;
...
struct<17> func_66(ePedComponentType epctParam0, int iParam1) // Position - 0x8209
{
	int i;
	var unk;
...
void func_67(var uParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0xA051
{
	int num;
	Hash outfit;
...
void func_69(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA2EB
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_70(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xA35C
{
	func_139();
...
BOOL func_82(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xD5DA
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xD618
{
...
int func_140(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x21ABC
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_70(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79322[1 /*14*/] = { func_70(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79322[1 /*14*/] = { func_70(entityModel, 14, unk18[j], -1) };
							func_157(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_163(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_50(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79322[1 /*14*/] = { func_70(entityModel, i, func_147(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79322[1 /*14*/] = { func_70(entityModel, 14, unk59[j], -1) };
			func_157(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_163(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_50(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
...
BOOL func_141(Ped pedParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x222CD
{
	int num;
	...
	{
		if (!func_49(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_64, Global_114135.f_2367.f_539[num /*65*/].f_63))
		{
...
int func_142(ePedComponentType epctParam0) // Position - 0x2236E
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
void func_143(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x223A9
{
	int num;
	int num2;
...
BOOL func_144(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x22433
{
	if (epctParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_145(ePedComponentType epctParam0, int iParam1, int iParam2) // Position - 0x22511
{
	Global_79322[1 /*14*/] = { func_70(epctParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_146(Ped pedParam0, ePedComponentType epctParam1, var uParam2, int iParam3) // Position - 0x22539
{
	int num;
	...
	{
		if (!func_49(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_61, Global_114135.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
ePedComponentType func_147(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x225E4
{
	ePedComponentType i;
	ePedComponentType j;
...
int func_148(ePedComponentType epctParam0, int iParam1, int iParam2, var uParam3) // Position - 0x22685
{
	int num;
...
ePedComponentType func_149(Ped pedParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0x2298C
{
	int num;
	int num2;
	int num3;
...
int func_151(ePedComponentType epctParam0, int iParam1, int iParam2, int iParam3) // Position - 0x23823
{
	int num;
...
int func_152(ePedComponentType epctParam0, int iParam1, int iParam2, int iParam3) // Position - 0x23AEA
{
	int i;
	int num;
...
BOOL func_154(ePedComponentType epctParam0, int iParam1, var uParam2) // Position - 0x23B4A
{
	*uParam2 = -99;
...
int func_155(ePedComponentType epctParam0, int iParam1, int iParam2, var uParam3) // Position - 0x23E14
{
	int num;
...
int func_156(ePedComponentType epctParam0, int iParam1, int iParam2) // Position - 0x2409F
{
	switch (epctParam0)
	{
		case joaat("Player_Zero"):
...
void func_157(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x241F6
{
	ePedComponentType type;
...
BOOL func_158(ePedComponentType epctParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x24290
{
	switch (epctParam0)
	{
		case joaat("MP_M_Freemode_01"):
...
ePedComponentType func_159(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x2435E
{
	Hash entityModel;
...
ePedComponentType func_162(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x2461E
{
	int pedPropIndex;
...
void func_164(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x24711
{
	int num;
	int offset;
	int num2;
...
int func_174(Ped pedParam0, eCharacter echParam1) // Position - 0x262DE
{
	int num;
...
char* func_188(Hash hParam0) // Position - 0x2B38C
{
	switch (hParam0)
	{
