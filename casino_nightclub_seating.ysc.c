...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x2706
{
...
BOOL func_89(Ped pedParam0) // Position - 0x2C52
{
	int scriptTaskStatus;
...
void func_90(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C83
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D53
{
	Hash statName;
...
BOOL func_93(Player plParam0) // Position - 0x2DC7
{
...
BOOL func_95(Player plParam0, int iParam1) // Position - 0x2E14
{
	BOOL flag;
...
BOOL func_98(Player plParam0) // Position - 0x2EBA
{
	Player player;
