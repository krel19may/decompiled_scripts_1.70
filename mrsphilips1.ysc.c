...
struct<10> func_78(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9786
{
	int i;
	var unk;
...
struct<17> func_81(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA227
{
	int i;
	var unk;
...
struct<14> func_85(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC37D
{
	func_149();
...
BOOL func_92(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE688
{
	int num;
	int num2;
	int num3;
...
BOOL func_150(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FA23
{
	Hash entityModel;
	ePedComponentType type;
	int i;
	...
	if (Global_79794 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_241(Global_79795, Global_79797, iParam10) };
				y == -0.014f;
...
int func_275(const char* sParam0) // Position - 0x28D20
{
...
int func_277(const char* sParam0, BOOL bParam1) // Position - 0x28D9A
{
	Hash hashKey;
	int num;
