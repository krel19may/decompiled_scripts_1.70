...
void func_20(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEF
{
...
eCharacter func_79(int iParam0, BOOL bParam1) // Position - 0x3F18
{
