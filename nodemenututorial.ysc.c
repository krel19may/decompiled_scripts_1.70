...
void func_109(BOOL bParam0, int iParam1) // Position - 0x2408
{
	...
	if (bParam0)
	{
		func_110(&Global_23970.f_6263[num /*10*/]);
...
BOOL func_115(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2A95
{
	...
	flag2 = func_116(&Global_23970.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_116(int* piParam0) // Position - 0x2BA3
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_121(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x2CBE
{
...
void func_123(var uParam0, int iParam1) // Position - 0x2D83
{
	uParam0->f_29 = iParam1;
	return;
}

BOOL func_124(int* piParam0, var uParam1) // Position - 0x2D91
{
	func_149(piParam0);
	return func_125(piParam0) != 0;
}

int func_125(int* piParam0) // Position - 0x2DA7
{
	int num;
...
int func_126(int* piParam0) // Position - 0x2E0F
{
...
int func_127(int* piParam0) // Position - 0x2E43
{
...
void func_128(int* piParam0) // Position - 0x2E84
{
	if (!func_70(piParam0))
		return;
...
void func_131(int* piParam0) // Position - 0x2EEF
{
	if (!func_70(piParam0))
		return;
...
int func_133(int* piParam0) // Position - 0x2F42
{
...
void func_134(int* piParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2F68
{
	var unk;
...
function func_135(var uParam0) // Position - 0x304F
{
	return uParam0->f_17;
}

ePedComponentType func_136(var uParam0) // Position - 0x305B
{
	return *uParam0;
}

BOOL func_137(int* piParam0, var uParam1) // Position - 0x3066
{
	return func_138(&(piParam0->f_6), uParam1);
}

BOOL func_138(var uParam0, var uParam1) // Position - 0x3078
{
	if (uParam0->f_10 == 0)
		return 0;
...
int func_140(int* piParam0) // Position - 0x30AC
{
...
int func_141(int* piParam0, int iParam1) // Position - 0x30EF
{
	int num;
...
BOOL func_142(var uParam0) // Position - 0x3136
{
	if (uParam0->f_18 == 0)
		return false;
...
int func_143(int* piParam0) // Position - 0x314F
{
	return func_33(&(piParam0->f_6));
}

int func_144(int* piParam0) // Position - 0x315F
{
...
BOOL func_145(int* piParam0, int iParam1) // Position - 0x31AE
{
	BOOL flag;
	ePedComponentType type;
...
int func_146(int* piParam0) // Position - 0x322E
{
	var unk;
...
ePedComponentType func_147(int* piParam0) // Position - 0x326C
{
	if (!func_14(&(piParam0->f_6.f_7), 2))
		return PV_COMP_HEAD;
...
ePedComponentType func_148(int* piParam0) // Position - 0x328D
{
	return func_136(&(piParam0->f_6));
}

void func_149(int* piParam0) // Position - 0x329D
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
		return;
...
void func_150(int* piParam0) // Position - 0x32E3
{
...
void func_151(int* piParam0) // Position - 0x3304
{
	BOOL flag;
...
void func_157(int* piParam0) // Position - 0x33CA
{
...
void func_158(int* piParam0) // Position - 0x341C
{
	func_18(piParam0, Global_4542450);
	return;
}

BOOL func_159(int* piParam0) // Position - 0x342F
{
...
void func_161(int* piParam0) // Position - 0x3460
{
	int num;
	...
	if (num4 >= x && num4 <= x2 && num5 >= y && num5 <= y2)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || num10 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_166(num, num2 + ((float)num10 * 0.034722f), Global_23969, 0.034722f - 0.0015f, 255, 255, 255, num7);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_166(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x386A
{
...
void func_167(BOOL bParam0) // Position - 0x3899
{
	...
	if (Global_4542450 == -2)
		func_166(num, num2, Global_23969, num3, 255, 255, 255, num4);
	else if (Global_4542450 == -3)
		func_166(num, num2 + num3, Global_23969, num3, 255, 255, 255, num4);
...
void func_170(var uParam0, var uParam1) // Position - 0x3978
{
	func_171(uParam1, func_185(uParam0), 0, 1, 0, false, 0);
	return;
}

void func_171(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3991
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_184(Global_23970.f_5821, true);
	else
		func_184(Global_23970.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_181(&Global_23970.f_79[Global_23970.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_172(&Global_23970.f_79[Global_23970.f_5823 /*6*/]);
...
BOOL func_173(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x3BC9
{
	var textureDict;
	var textureName;
	int num;
...
void func_175(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x3DC9
{
	float num;
	float value;
	float aspectRatio;
...
char* func_177(int iParam0, BOOL bParam1) // Position - 0x3E6C
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_178(const char* sParam0) // Position - 0x4394
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x439E
{
	var gamerHandle;
...
void func_182(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x4467
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_183(Global_23970.f_6614[iParam4], &r, &g, &b);
...
void func_184(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x489F
{
	int num;
...
char* func_185(var uParam0) // Position - 0x48EB
{
	return uParam0->f_3;
}
...
void func_194(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x4B0D
{
	int num;
	int r;
	int g;
	...
	if (bParam3)
	{
		...
		{
			func_171(Global_23970.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 && Global_23970.f_6331)
		{
			...
			else
			{
				if (Global_23970)
				{
					...
					{
						func_166(Global_23967, Global_23968, iParam5, height3, 0, 0, 0, 255);
				...
				func_166(Global_23967, Global_23968 + height3, iParam5, 0.034722f, r, g, b, a);
				...
				{
					func_220();
					func_218((Global_23967 + iParam5) - 0.00390625f - func_219("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6339, Global_23970.f_6340);
				}
				else if (Global_23970.f_6334 > Global_23970.f_5828)
				{
					...
					{
						func_220();
						func_218((Global_23967 + iParam5) - 0.00390625f - func_219("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336), Global_23968 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23970.f_6337, Global_23970.f_6336);
					}
				}
			}
			...
			if (Global_23970.f_6334 > Global_23970.f_5828)
			{
				...
				func_166(Global_23967, num28 + 0f, iParam5, 0.034722f, r, g, b, a);
			...
			if (MISC::GET_HASH_KEY(&(Global_23970.f_5241)) != 0 && Global_23970.f_5323 != -1)
			{
				...
				{
					func_173(Global_23970.f_5325, true, true, &width, &height, bParam7);
				...
				func_166(Global_23967, num28 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_173(Global_23970.f_5325, true, true, &width, &height, bParam7);
					func_216(Global_23970.f_5325, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_5325), func_177(Global_23970.f_5325, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4542374.f_21)) != 0 && Global_4542374.f_65 != -1)
			{
				...
				{
					func_173(Global_4542374.f_67, true, true, &width, &height, bParam7);
					x = (Global_23967 + width + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_173(Global_4542374.f_67, true, true, &width, &height, bParam7);
					func_216(Global_4542374.f_67, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_180(Global_4542374.f_67), func_177(Global_4542374.f_67, true), Global_23967 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
						...
						switch (Global_23970.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0)
										{
											...
											func_182(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, num35, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_173(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													num25 = num25 + width;
									...
									if (MISC::GET_HASH_KEY(&Global_23970.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_182(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23970.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_173(Global_23970.f_4984[num14 + num20], flag, false, &width, &height, bParam7))
												{
													x = x + (width * 0.5f);
												
													if (func_173(Global_23970.f_4984[num14 + num20], flag, true, &width, &height, bParam7))
													{
														func_216(Global_23970.f_4984[num14 + num20], flag, &red, &green, &blue, &alpha);
													
														if (i == 1)
															if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14 + num20]), func_177(Global_23970.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14 + num20]), func_177(Global_23970.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_182(false, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23970.f_4984[num14 + l] != 2 && Global_23970.f_4984[num14 + l] != 54 && Global_23970.f_4984[num14 + l] != 64)
											{
												if (func_173(Global_23970.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_173(Global_23970.f_4984[num14 + l], flag, true, &width, &height, bParam7))
														{
															func_216(Global_23970.f_4984[num14 + l], flag, &red, &green, &blue, &alpha);
														
															if (Global_23970.f_4984[num14 + l] == 30)
																GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14 + l]), func_177(Global_23970.f_4984[num14 + l], flag), Global_23967 + (width * 0.5f), (y + 0.00277776f + (height * 0.5f)) - (0.00078125f * 11f), width, height, 0f, red, green, blue, alpha, false, 0);
															else if (Global_23970.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14 + l]), func_177(Global_23970.f_4984[num14 + l], flag), ((num24 + x + screenWidthOfDisplayText) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14 + l]), func_177(Global_23970.f_4984[num14 + l], flag), (num24 + x + screenWidthOfDisplayText) - (0.00078125f * 12f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23970.f_6332)
									{
										func_182(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_182(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
										func_205(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_182(flag, Global_23970.f_1616[num16], Global_23970.f_1873[num16], flag7, 0, false, false);
									func_204(num24 + x, y, "NUMBER" /*~1~*/, Global_23970.f_4726[num13], Global_23970.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_173(Global_23970.f_4984[num14], flag, false, &width, &height, bParam7))
									{
										if (!Global_23970.f_6332)
										{
											num25 = width;
										...
										if (i == 1)
										{
											if (func_173(Global_23970.f_4984[num14], flag, true, &width, &height, bParam7))
											{
												func_216(Global_23970.f_4984[num14], flag, &red, &green, &blue, &alpha);
												GRAPHICS::DRAW_SPRITE(func_180(Global_23970.f_4984[num14]), func_177(Global_23970.f_4984[num14], flag), num24 + x + (width * 0.5f), (y - 0.00277776f) + (height2 * 0.5f), width * func_203(Global_23970.f_4984[num14]), height * func_203(Global_23970.f_4984[num14]), 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
								}
...
BOOL func_201(int iParam0) // Position - 0x7E3D
{
	if (iParam0 == 1)
...
void func_205(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x7F31
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_207(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x7F95
{
	int num;
	int i;
	int j;
...
BOOL func_210(Player plParam0, int iParam1) // Position - 0x84B9
{
	BOOL flag;
...
eCharacter func_211(int iParam0, BOOL bParam1) // Position - 0x8512
{
...
BOOL func_213(Player plParam0) // Position - 0x855F
{
	Player player;
...
void func_216(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x8609
{
...
void func_218(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x8789
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(epctParam3);
...
float func_219(char* sParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x87AC
{
	if (!MISC::IS_STRING_NULL(sParam0))
		if (MISC::GET_HASH_KEY(sParam0) == 0)
			return 0f;
...
BOOL func_221(BOOL bParam0, BOOL bParam1) // Position - 0x8878
{
	if (Global_2672939.f_1761.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_223(8, -1) && func_222() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79800 || Global_23970.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101740.f_1490)
		return false;

	return true;
}

eTransitionState func_222() // Position - 0x8915
{
	return Global_1575012;
}

BOOL func_223(int iParam0, int iParam1) // Position - 0x8921
{
	switch (iParam0)
	{
		case 5:
...
int func_225(int* piParam0) // Position - 0x8967
{
	func_245(-1);
	func_112(true, false);
	func_242(piParam0);
...
void func_226(int* piParam0) // Position - 0x89A7
{
	if (func_13(piParam0, 3))
	{
...
void func_227(int* piParam0) // Position - 0x89F7
{
...
function func_229(var uParam0) // Position - 0x8A2A
{
	return uParam0->f_27;
}

void func_230(int* piParam0) // Position - 0x8A36
{
...
function func_232(var uParam0) // Position - 0x8A69
{
	return uParam0->f_30;
}

void func_233(int* piParam0) // Position - 0x8A75
{
	function func;
	int num;
	int num2;
...
BOOL func_234(int* piParam0, int iParam1, var uParam2) // Position - 0x8B14
{
	if (func_27(uParam2))
		return false;
...
void func_235(var uParam0, int iParam1) // Position - 0x8B42
{
	if (uParam0->f_16 == 0)
		return;
...
void func_236(int* piParam0, int iParam1) // Position - 0x8B5E
{
	piParam0->f_2 = iParam1;
	return;
}

void func_237(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8B6C
{
...
void func_238(int* piParam0) // Position - 0x8BAB
{
...
const char* func_240(const char* sParam0) // Position - 0x8C2C
{
	return sParam0;
}

char* _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x8C36
{
	return uParam0->f_1;
}

void func_242(int* piParam0) // Position - 0x8C42
{
	func_244(1, 1, 0, 0, 0);
	func_243(1, 2, 1, 1, 1);
	func_4(piParam0);
