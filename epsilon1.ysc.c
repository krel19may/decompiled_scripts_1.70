...
ePedComponentType func_89(ePedComponentType epctParam0) // Position - 0x9CC7
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_90(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9D77
{
	int i;
	var unk;
...
struct<17> func_93(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA818
{
	int i;
	var unk;
...
void func_96(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC8FC
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_97(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC96D
{
	func_161();
...
BOOL func_162(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x2003F
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x2092C
{
...
void func_243(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x281F7
{
...
int func_358(const char* sParam0) // Position - 0x2D708
{
...
int func_360(const char* sParam0, BOOL bParam1) // Position - 0x2D782
{
	Hash hashKey;
	int num;
