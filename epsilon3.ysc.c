...
ePedComponentType func_103(ePedComponentType epctParam0) // Position - 0xA343
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_104(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA3F3
{
	int i;
	var unk;
...
struct<17> func_107(Hash hParam0, ePedComponentType epctParam1) // Position - 0xAE94
{
	int i;
	var unk;
...
void func_110(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCF79
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_111(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xCFEA
{
	func_174();
...
BOOL func_175(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x206C1
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x20E34
{
...
void func_231(eCharacter echParam0, int iParam1, int iParam2, char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11, const char* sParam12, const char* sParam13) // Position - 0x283E2
{
	eCharacter character;
	BOOL flag;
	var txdName;
...
int func_325(Entity eParam0, eCharacter echParam1) // Position - 0x2C735
{
	int num;
...
int func_351(const char* sParam0) // Position - 0x2CEFB
{
...
int func_353(const char* sParam0, BOOL bParam1) // Position - 0x2CF75
{
	Hash hashKey;
	int num;
