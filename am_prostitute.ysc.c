...
Hash func_19(Player plParam0) // Position - 0x956
{
...
Hash func_21(Player plParam0) // Position - 0x9BD
{
	if (func_10(plParam0))
...
BOOL func_24(Hash hParam0) // Position - 0xA47
{
	switch (hParam0)
	{
		case 243:
...
int func_33(Hash hParam0) // Position - 0xB93
{
	switch (hParam0)
	{
		case 0:
...
BOOL func_35(Player plParam0) // Position - 0x10B8
{
	return Global_2657991[plParam0 /*467*/].f_123 == 7;
}

BOOL func_36(Player plParam0) // Position - 0x10CD
{
	return Global_2657991[plParam0 /*467*/].f_123 == 2;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x10E2
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1166
{
	switch (func_40())
	{
		case 0:
