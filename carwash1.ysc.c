...
int func_117(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, ePedComponentType epctParam5, int iParam6, int iParam7) // Position - 0x98E3
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_118(int iParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x9A90
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_120(Hash hParam0) // Position - 0x9B1C
{
	hParam0->f_65 = 0;
...
void func_123(int iParam0, Hash hParam1) // Position - 0x9C9A
{
...
int func_124(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9CAE
{
	int i;
...
int func_127(Player plParam0) // Position - 0x9E8F
{
	var address;
...
Hash func_138(int iParam0, int iParam1) // Position - 0xAAD5
{
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xAD0D
{
	if (iParam1 == -1)
		iParam1 = func_10();
...
void func_159(Hash hParam0, int iParam1) // Position - 0xB0ED
{
	int outValue;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xB315
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xB352
{
...
Hash func_168(eCharacter echParam0) // Position - 0xB377
{
...
int func_171(Player plParam0) // Position - 0xB41A
{
	int num;
...
int func_172(Player plParam0) // Position - 0xB42C
{
	if (plParam0 > -1)
		if (plParam0 == PLAYER::PLAYER_ID())
...
BOOL func_173(Player plParam0) // Position - 0xB46F
{
	if (!func_11(plParam0))
		return false;
...
void func_174(Vehicle veParam0) // Position - 0xB48E
{
	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		return;
...
int func_176(Vehicle veParam0, var uParam1, int iParam2) // Position - 0xB4EE
{
	Ped pedInVehicleSeat;
	int taskSequenceId;
...
void func_178(Vehicle veParam0, var uParam1, float fParam2, float fParam3) // Position - 0xB67B
{
	Vector3 vector;
	float heading;
	Ped pedInVehicleSeat;
...
Vector3 func_179(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xB750
{
	var groundZ;
...
void func_191(var uParam0, const char* sParam1) // Position - 0xC364
{
...
int func_196(var uParam0, int iParam1, int iParam2, const char* sParam3, const char* sParam4) // Position - 0xC830
{
	if (IS_BIT_SET(uParam0->f_113, iParam1) || IS_BIT_SET(uParam0->f_114, iParam1))
		return 1;
...
void func_198(var uParam0, const char* sParam1) // Position - 0xC94B
{
	func_197(uParam0, 0, joaat("prop_carwash_roller_horz"));
	func_197(uParam0, 1, joaat("prop_carwash_roller_vert"));
	func_197(uParam0, 2, joaat("prop_ld_test_01"));
...
void func_211(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xCC1A
{
	float distanceBetweenCoords;
	float num;
	Vector3 vector;
...
float func_212(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xCCC6
{
...
int func_215(Ped pedParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCEDA
{
	int i;
	int j;
	int k;
...
BOOL func_216(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0xD6EB
{
	int num;
...
int func_217(Hash hParam0) // Position - 0xD78C
{
	switch (hParam0)
	{
...
void func_218(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xD7C7
{
	Hash hash;
	int num;
...
BOOL func_219(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD851
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_220(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD92F
{
	Global_79322[1 /*14*/] = { func_263(hParam0, iParam1, hParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_221(Hash hParam0, Hash hParam1, int iParam2, Hash hParam3, var uParam4, int iParam5) // Position - 0xD957
{
	var unk;
	int i;
...
BOOL func_222(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xDF5B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_223(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xDFF4
{
	int num;
...
Hash func_224(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE09F
{
	Hash i;
	Hash j;
...
ePedComponentType func_225(int iParam0) // Position - 0xE140
{
	switch (iParam0)
	{
		case 0:
...
int func_226(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0xE1F0
{
	int num;
...
Hash func_227(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0xE4F7
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_228(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, var uParam4) // Position - 0xF0AA
{
	int num;
...
Hash func_229(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0xF38E
{
	int num;
...
Hash func_230(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF655
{
	Hash i;
	Hash hash;
...
BOOL func_231(Ped pedParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xF68C
{
	Hash hash;
...
BOOL func_232(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xF6B5
{
	*uParam2 = -99;
...
int func_233(Hash hParam0, int iParam1, Hash hParam2, var uParam3) // Position - 0xF97F
{
	int num;
...
Hash func_234(Hash hParam0, Hash hParam1, Hash hParam2) // Position - 0xFC09
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_235(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0xFD60
{
	Hash hash;
...
BOOL func_236(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0xFDFA
{
	switch (hParam0)
	{
...
Hash func_237(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xFEC8
{
	var outProp;
	int componentId;
	int num;
...
int func_238(Hash hParam0, int iParam1) // Position - 0xFFE2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_239(Hash hParam0) // Position - 0x10389
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_240(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x103EA
{
	Hash entityModel;
...
int func_241(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x104E6
{
	Hash entityModel;
...
int func_242(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x10624
{
	var outfit;
	int i;
	int num;
...
int func_243(Hash hParam0) // Position - 0x106DF
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_244(ePedComponentType epctParam0) // Position - 0x1073E
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_245(Hash hParam0, Hash hParam1) // Position - 0x107C4
{
	int i;
	var unk;
...
void func_246(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x110F3
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_248(Hash hParam0, Hash hParam1) // Position - 0x11265
{
	int i;
	var unk;
...
void func_249(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x130AD
{
	int num;
	Hash outfit;
...
void func_251(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x13347
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
BOOL func_252(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x133B8
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_253(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x13635
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_254(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x13A5A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
Hash func_255(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13D4D
{
	int pedPropIndex;
...
Hash func_256(Ped pedParam0, int iParam1) // Position - 0x13D94
{
...
int func_257(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x13DF4
{
	ePedComponentType componentId;
...
void func_259(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x13EF7
{
	int num;
	int offset;
	int num2;
...
BOOL func_260(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x13F3F
{
...
struct<14> func_263(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0x17AD0
{
	func_326();
...
BOOL func_270(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x19E28
{
	int num;
	int num2;
	int num3;
...
void func_272(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x19F3A
{
	int num;
	int num2;
	Hash outfit;
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x2D61F
{
	Vehicle vehiclePedIsIn;
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2D728
{
	switch (func_22())
	{
		case 0:
...
Hash func_378() // Position - 0x2D75B
{
...
BOOL IS_XBOX_PLATFORM() // Position - 0x2D860
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2D876
{
...
BOOL func_389() // Position - 0x2D942
{
