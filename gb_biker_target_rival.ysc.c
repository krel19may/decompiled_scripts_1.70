...
BOOL func_19(ePedComponentType epctParam0) // Position - 0xCF9
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2657991[epctParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_20(ePedComponentType epctParam0) // Position - 0xD40
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2657991[epctParam0 /*467*/].f_324.f_8 != -1)
...
BOOL func_21(ePedComponentType epctParam0, ePedComponentType epctParam1, BOOL bParam2) // Position - 0xD87
{
...
int func_22(ePedComponentType epctParam0) // Position - 0xDE0
{
...
ePedComponentType func_23(BOOL bParam0) // Position - 0xE06
{
	if (bParam0)
		return 118;
...
ePedComponentType func_24(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE1D
{
	int playerTeam;
	Ped ped;
...
ePedComponentType func_25(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x1008
{
	return func_26(PLAYER::PLAYER_ID(), bParam0, iParam1, bParam2);
}

ePedComponentType func_26(ePedComponentType epctParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x101E
{
	int playerTeam;
...
BOOL func_28(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1239
{
	int i;
...
BOOL func_33(ePedComponentType epctParam0) // Position - 0x1790
{
	return IS_BIT_SET(Global_1845221[epctParam0 /*889*/].f_36.f_18, 14);
}

BOOL func_34(ePedComponentType epctParam0, int iParam1) // Position - 0x17A8
{
	BOOL flag;
...
ePedComponentType func_42(ePedComponentType epctParam0, ePedComponentType epctParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1934
{
	int playerTeam;
	BOOL flag;
	ePedComponentType type;
...
ePedComponentType func_43(BOOL bParam0) // Position - 0x1ACC
{
	if (bParam0)
		return 119;
...
ePedComponentType func_44(int iParam0) // Position - 0x1AE3
{
	int num;
...
int func_45(int iParam0) // Position - 0x1BA6
{
	return Global_2648914.f_818.f_44[iParam0 /*2*/].f_1;
}

int func_46(ePedComponentType epctParam0) // Position - 0x1BBD
{
	if (func_11(epctParam0))
...
ePedComponentType func_47(ePedComponentType epctParam0) // Position - 0x1BED
{
	if (func_11(epctParam0))
...
BOOL func_48(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x1C10
{
	if (!func_11(epctParam0))
		return false;
...
BOOL func_49(ePedComponentType epctParam0) // Position - 0x1C48
{
	if (func_11(epctParam0))
		if (func_11(Global_1887549[epctParam0 /*611*/].f_10))
...
BOOL func_58(Hash hParam0) // Position - 0x1DE1
{
	int i;
...
BOOL func_60(Hash hParam0) // Position - 0x1E30
{
	int i;
...
BOOL func_64() // Position - 0x1E94
{
	return Global_2684718.f_18;
}

BOOL func_65() // Position - 0x1EA2
{
	return Global_2684718.f_17;
}

ePedComponentType func_66(int iParam0, ePedComponentType epctParam1, BOOL bParam2) // Position - 0x1EB0
{
	ePedComponentType type;
	int num;
	int num2;
...
ePedComponentType func_67(int iParam0) // Position - 0x2030
{
	int num;
...
BOOL func_71(ePedComponentType epctParam0) // Position - 0x213B
{
...
BOOL func_73(ePedComponentType epctParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x2188
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
BOOL func_78(int iParam0, var uParam1, int* piParam2, BOOL bParam3, Player plParam4, BOOL bParam5, var uParam6) // Position - 0x233A
{
	if (bParam5)
	{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2422
{
	switch (func_82())
	{
		case 0:
...
BOOL func_86(int iParam0) // Position - 0x253E
{
...
int func_88(eHudColour ehcParam0) // Position - 0x25B3
{
	int r;
	int g;
	int b;
...
int func_89(ePedComponentType epctParam0) // Position - 0x281B
{
	int num;
...
void func_91(Player plParam0, eBlipSprite ebsParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2852
{
	BOOL flag;
