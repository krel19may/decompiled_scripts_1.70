...
ePedComponentType func_143(ePedComponentType epctParam0) // Position - 0xBEB7
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_144(Hash hParam0, ePedComponentType epctParam1) // Position - 0xBF67
{
	int i;
	var unk;
...
struct<17> func_147(Hash hParam0, ePedComponentType epctParam1) // Position - 0xCA0A
{
	int i;
	var unk;
...
void func_150(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xEAEC
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_151(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xEB5D
{
	func_214();
...
void func_391(ePedComponentType epctParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, BOOL bParam12, int iParam13, int iParam14, int iParam15) // Position - 0x3018C
{
	int num;
	int i;
...
BOOL func_448(eCharacter echParam0) // Position - 0x3383D
{
	if (!func_3(echParam0))
		return false;
...
int func_453(Entity eParam0, eCharacter echParam1) // Position - 0x33ACE
{
	int num;
...
int func_475(const char* sParam0) // Position - 0x3437F
{
...
int func_477(const char* sParam0, BOOL bParam1) // Position - 0x343FD
{
	Hash hashKey;
	int num;
