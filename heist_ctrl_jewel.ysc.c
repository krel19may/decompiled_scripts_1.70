...
void func_13(const char* sParam0, BOOL bParam1) // Position - 0xA07
{
	int i;
	int j;
...
void func_108(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x4088
{
...
void func_114(int iParam0, BOOL bParam1) // Position - 0x5901
{
...
int func_163(var uParam0, int iParam1, eCharacter echParam2) // Position - 0x7C82
{
	eCharacter character;
	var unk;
	var unk99;
...
BOOL func_164(int iParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7D9F
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
BOOL func_167(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0xB8E1
{
	int i;
	Hash outData;
...
BOOL func_168(ePedComponentType epctParam0) // Position - 0xBA66
{
	int num;
	var unk;
	var name;
...
BOOL func_170(ePedComponentType epctParam0, int iParam1) // Position - 0xBB49
{
	int cloudTimeAsInt;
	int num;
...
BOOL func_180(eCharacter echParam0, var uParam1, var uParam2) // Position - 0xC136
{
	switch (echParam0)
	{
		case CHAR_STEVE_TREV_CONF:
...
void func_195(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCFAD
{
	if (bParam0)
	{
...
BOOL func_197(Player plParam0, int iParam1) // Position - 0xD116
{
	BOOL flag;
...
BOOL func_200(Player plParam0) // Position - 0xD1BC
{
	Player player;
...
BOOL func_201(Player plParam0) // Position - 0xD1DE
{
...
int func_203(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD22B
{
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC44
{
...
BOOL func_231(eCharacter echParam0) // Position - 0xE900
{
	int i;
...
void func_234(var uParam0, int iParam1) // Position - 0xEA61
{
...
void func_243(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF08A
{
	uParam0->f_1 = iParam1;
