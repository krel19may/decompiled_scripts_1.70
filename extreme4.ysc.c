...
ePedComponentType func_84(ePedComponentType epctParam0) // Position - 0x9983
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_85(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9A33
{
	int i;
	var unk;
...
struct<17> func_88(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA4D4
{
	int i;
	var unk;
...
void func_91(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC5B8
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_92(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC629
{
	func_156();
...
void func_231(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27A82
{
...
int func_327(Entity eParam0, eCharacter echParam1) // Position - 0x2BCC9
{
	int num;
...
int func_360(const char* sParam0) // Position - 0x2C89C
{
...
int func_362(const char* sParam0, BOOL bParam1) // Position - 0x2C916
{
	Hash hashKey;
	int num;
