...
void func_2() // Position - 0xD7
{
	...
	if (!flag)
	{
		if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_76(echLocal_57) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || func_75() || CUTSCENE::IS_CUTSCENE_PLAYING() || CAM::IS_SCREEN_FADED_OUT() || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || Global_79537 || Global_98947 || bLocal_60)
		{
			bLocal_81 = true;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_55 > 2000 || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::IS_TIME_MORE_THAN(NETWORK::GET_NETWORK_TIME(), NETWORK::GET_TIME_OFFSET(iLocal_56, 2000)) || bLocal_58)
	{
		...
		for (j = 0; j < num3; j = j + 1)
		{
			...
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				...
				outValue = Global_114135.f_2367.f_539.f_2387[echLocal_57];
			else
			...
			if (func_59(echLocal_57, num2, outValue, &value))
			{
				...
				{
					if (Global_114135.f_2367.f_539.f_2387[echLocal_57] == PV_COMP_HEAD)
						flag2 = false;
				
					Global_114135.f_2367.f_539.f_2387[echLocal_57] = value;
				}
				else
				{
...
BOOL func_9() // Position - 0x841
{
	...
	if (Global_1928988 == frameCount)
	{
		return Global_1928989;
	}
	else
	{
		Global_1928988 = frameCount;
		Global_1928989 = false;
	}

	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && IS_BIT_SET(Global_4718592.f_39, 19) || func_45(*Global_4718592.f_187633, true))
			return false;
	...
	if (IS_BIT_SET(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_885, 16))
		return false;
	...
	if (Global_2685658.f_2847.f_26 == true)
		return false;
	...
	if (IS_BIT_SET(Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_885, 6))
		return false;
...
{
	return IS_BIT_SET(Global_1882780[plParam0 /*149*/].f_17, 0);
}

BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xC68
{
	ePedComponentType type;
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0xFF1
{
	iParam0->f_1 = 0;
	return;
}

int func_37(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFFE
{
	if (iParam1 == -1)
		return 1;
...
void _STOPWATCH_INITIALIZE(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1068
{
	if (pStopwatch->f_1 == 0)
	{
...
BOOL func_49(ePedComponentType epctParam0) // Position - 0x125A
{
	if (func_50(epctParam0))
		if (func_50(Global_1887549[epctParam0 /*611*/].f_10))
			return Global_1887549[epctParam0 /*611*/].f_10 == epctParam0;

	return false;
}

BOOL func_50(ePedComponentType epctParam0) // Position - 0x128F
{
	Player player;
...
BOOL func_52(Player plParam0, BOOL bParam1) // Position - 0x12C3
{
	...
	return func_50(Global_1887549[plParam0 /*611*/].f_10);
}
...
ePedComponentType func_55(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x1533
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (func_56(14))
			return 100;
...
void func_57(int iParam0, ePedComponentType epctParam1, int iParam2, BOOL bParam3) // Position - 0x1787
{
	Hash statName;
...
BOOL func_59(eCharacter echParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x17CA
{
...
ePedComponentType func_60(eCharacter echParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x17EC
{
	float value;
	float outValue;
	ePedComponentType type;
	...
	switch (iParam1)
	{
		...
		case 1:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (outValue - Global_114135.f_2367.f_539.f_2355[echParam0]) / 175f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 2:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = SYSTEM::TO_FLOAT(outValue2 - Global_114135.f_2367.f_539.f_2359[echParam0]) / 20f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 4:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + (SYSTEM::TO_FLOAT(outValue2 - Global_114135.f_2367.f_539.f_2363[echParam0]) / 50f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 7:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = (outValue - Global_114135.f_2367.f_539.f_2367[echParam0]) / 45f;
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
			...
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = value + ((SYSTEM::TO_FLOAT(outValue2 - Global_114135.f_2367.f_539.f_2371[echParam0]) / 2f) * 1.5f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
		...
		case 6:
			if (echParam0 == CHAR_MICHAEL)
			{
				...
				value = SYSTEM::TO_FLOAT(outValue3 - Global_114135.f_2367.f_539.f_2375[echParam0]) / 40f;
				value = value + (SYSTEM::TO_FLOAT(outValue4 - Global_114135.f_2367.f_539.f_2379[echParam0]) / 80f);
			}
			else if (echParam0 == CHAR_FRANKLIN)
			{
...
ePedComponentType func_61(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x250F
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
ePedComponentType func_68() // Position - 0x2754
{
	if (func_51(true))
		return Global_1845221[_GET_BOSS_OF_LOCAL_PLAYER() /*889*/].f_206.f_6;

	return PV_COMP_HEAD;
}

ePedComponentType _GET_BOSS_OF_LOCAL_PLAYER() // Position - 0x277A
{
...
ePedComponentType func_72(ePedComponentType epctParam0, int iParam1, int iParam2) // Position - 0x27C8
{
...
ePedComponentType func_73(int iParam0, int iParam1) // Position - 0x27ED
{
	Hash statHash;
	int outValue;
	...
	if (!bLocal_79)
	{
		...
		else
		{
			...
			if (Global_114135.f_2367.f_539.f_2280[echLocal_57] == 0)
				Global_114135.f_2367.f_539.f_2280[echLocal_57] = NETWORK::GET_CLOUD_TIME_AS_INT();
...
BOOL func_87(BOOL bParam0) // Position - 0x3490
{
	return Global_113220 && bParam0 != false;
}
...
int func_96(ePedComponentType epctParam0) // Position - 0x37F5
{
	int num;
...
void func_97(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x382B
{
...
BOOL func_98(ePedComponentType epctParam0) // Position - 0x3897
{
	int i;
...
int func_99(ePedComponentType epctParam0) // Position - 0x38C9
{
	int i;
...
void func_101(BOOL bParam0) // Position - 0x39FD
{
	*bParam0 = 0;
