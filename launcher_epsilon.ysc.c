...
ePedComponentType func_83() // Position - 0x79AE
{
...
BOOL func_86(ePedComponentType epctParam0) // Position - 0x79F2
{
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x88AC
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
int func_98(Player plParam0) // Position - 0x8BA4
{
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x928A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x92A0
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x92B6
{
...
void func_127(Ped pedParam0) // Position - 0xAF29
{
	int num;
	int num2;
	int num3;
...
int func_129(Ped pedParam0) // Position - 0xB005
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xB165
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xB1AE
{
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2F1
{
	int i;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB491
{
	if (bParam0)
	{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0xB5FA
{
	BOOL flag;
...
BOOL func_147(Player plParam0) // Position - 0xB694
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB6B6
{
...
int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB703
{
	int num;
...
BOOL func_153(const char* sParam0) // Position - 0xB780
{
...
BOOL func_156(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB82A
{
...
void func_157(Vehicle veParam0) // Position - 0xB881
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
int func_175(const char* sParam0, int iParam1) // Position - 0xC058
{
	int num;
	const char* str;
	Hash hashKey;
...
Blip func_178(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC534
{
	Blip blip;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xD411
{
	if (iParam2 == -1)
		iParam2 = func_52();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xD5EF
{
	if (iParam1 == -1)
		iParam1 = func_52();
...
BOOL func_212(int iParam0, int iParam1) // Position - 0xD9C1
{
...
void func_213(Hash hParam0, int iParam1) // Position - 0xDA12
{
	int outValue;
...
int func_217(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xDB18
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79322[1 /*14*/] = { func_266(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79322[1 /*14*/] = { func_266(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79322[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79322[1 /*14*/] = { func_266(entityModel, 14, unk18[j], -1) };
							func_238(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
							func_261(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_228(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_228(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_228(i), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79322[1 /*14*/] = { func_266(entityModel, i, func_227(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79322[1 /*14*/] = { func_266(entityModel, 14, unk59[j], -1) };
			func_238(pedParam0, Global_79322[1 /*14*/].f_12, Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4);
			func_261(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_228(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_228(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_228(iParam1), Global_79322[1 /*14*/].f_3, Global_79322[1 /*14*/].f_4, iParam4);
...
BOOL func_218(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0xE329
{
	int num;
	...
	{
		if (!func_219(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_64, Global_114135.f_2367.f_539[num /*65*/].f_63))
		{
...
BOOL func_219(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0xE3CA
{
	Hash entityModel;
	ePedComponentType type;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79322[1 /*14*/] = { func_266(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_219(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_219(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79322[2 /*14*/] = { func_266(entityModel, 14, k, -1) };
								
									if (Global_79322[2 /*14*/].f_12 == j)
										if (func_219(pedParam0, 14, k))
											if (!func_224(entityModel, epctParam2, 14, k, &unk, &Global_79322[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79322[2 /*14*/] = { func_266(entityModel, i, type, -1) };
					
						if (!func_224(entityModel, epctParam2, i, type, &unk, &Global_79322[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79322[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_228(epctParam1)) && Global_79322[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_228(epctParam1)))
	{
		return true;
	}
...
int func_220(Hash hParam0) // Position - 0xE623
{
	switch (hParam0)
	{
...
void func_221(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE65E
{
	ePedComponentType type;
	int num;
...
BOOL func_222(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE6E8
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_223(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE7C6
{
	Global_79322[1 /*14*/] = { func_266(hParam0, iParam1, epctParam2, -1) };
	return IS_BIT_SET(Global_79322[1 /*14*/].f_6, 2);
}

BOOL func_224(Hash hParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0xE7EE
{
	var unk;
	int i;
...
BOOL func_225(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xEDF2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_226(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xEE8B
{
	int num;
	...
	{
		if (!func_219(pedParam0, Global_114135.f_2367.f_539[num /*65*/].f_61, Global_114135.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
ePedComponentType func_227(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xEF36
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_228(int iParam0) // Position - 0xEFD7
{
	switch (iParam0)
	{
		case 0:
...
int func_229(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0xF087
{
	int num;
...
ePedComponentType func_230(Ped pedParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0xF38E
{
	ePedComponentType type;
	ePedComponentType type2;
	ePedComponentType type3;
...
BOOL func_231(int iParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3, var uParam4) // Position - 0xFF41
{
	int num;
...
ePedComponentType func_232(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x10226
{
	int num;
...
ePedComponentType func_233(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x104ED
{
	ePedComponentType i;
	ePedComponentType type;
...
BOOL func_234(Ped pedParam0, int iParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x10524
{
	ePedComponentType type;
...
BOOL func_235(Hash hParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x1054D
{
	*uParam2 = -99;
...
int func_236(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x10817
{
	int num;
...
ePedComponentType func_237(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x10AA1
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_238(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x10BF8
{
	ePedComponentType type;
...
BOOL func_239(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x10C92
{
	switch (hParam0)
	{
...
Hash func_240(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x10D60
{
	var outProp;
	int componentId;
	int num;
...
int func_241(Hash hParam0, int iParam1) // Position - 0x10E7A
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_242(Hash hParam0) // Position - 0x11221
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_243(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x11282
{
	Hash entityModel;
...
int func_244(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x1137E
{
	Hash entityModel;
...
int func_245(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x114BC
{
	var outfit;
	int i;
	int num;
...
int func_246(Hash hParam0) // Position - 0x11577
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_247(ePedComponentType epctParam0) // Position - 0x115D6
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_248(Hash hParam0, ePedComponentType epctParam1) // Position - 0x1165C
{
	int i;
	var unk;
...
void func_249(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x11F8B
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
struct<17> func_251(Hash hParam0, ePedComponentType epctParam1) // Position - 0x120FD
{
	int i;
	var unk;
...
void func_252(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x13F45
{
	int num;
	Hash outfit;
...
void func_254(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x141E0
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
BOOL func_255(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x14251
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_256(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x144CE
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_257(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x148F3
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_258(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x14BE6
{
	int pedPropIndex;
...
ePedComponentType func_259(Ped pedParam0, int iParam1) // Position - 0x14C2D
{
...
int func_260(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x14C8D
{
	ePedComponentType componentId;
...
void func_262(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x14D90
{
	int num;
	int offset;
	int num2;
...
BOOL func_263(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x14DD8
{
...
struct<14> func_266(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x188E7
{
	func_329();
...
BOOL func_273(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1AC3D
{
	int num;
	int num2;
	int num3;
...
void func_275(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1AD4F
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_269(&Global_79322[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_269(&Global_79322[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79520)
		{
			...
			func_269(&Global_79322[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
int func_330(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3, int iParam4) // Position - 0x2C237
{
	int num;
	int i;
	int j;
...
int func_331(Hash hParam0, int iParam1, ePedComponentType epctParam2, BOOL bParam3) // Position - 0x2C619
{
	Global_79322[1 /*14*/] = { func_266(hParam0, iParam1, epctParam2, -1) };
...
BOOL func_338(Vehicle veParam0) // Position - 0x2D09F
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_347() || Global_33090 || func_346() || func_345(8, -1) || func_343() || func_101() || func_344() || func_342() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_347() || Global_113182 || Global_33090 || func_346() || func_345(8, -1) || func_101() || func_344() || func_342() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_347() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_345(8, -1) || func_342() || func_341() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_347() || Global_33090 || func_346() || func_345(8, -1) || func_344() || func_343() || func_342() || Global_114135.f_7692.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_347() || func_344() || Global_113182 || Global_33090 || func_346() || Global_45392 || func_345(8, -1) || func_343() || func_341() || func_342() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
void func_349(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2D91E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
float func_353(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x2DB22
{
...
BOOL func_363(Player plParam0) // Position - 0x2E104
{
	return func_364(plParam0, 20);
}

BOOL func_364(Player plParam0, int iParam1) // Position - 0x2E114
{
...
void func_371(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2E3DD
{
...
BOOL func_380(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2E8B0
{
...
BOOL func_382(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E9A9
{
	float num;
...
BOOL func_383(Ped pedParam0, int iParam1) // Position - 0x2EA64
{
	float xSize;
...
BOOL func_384(Vehicle veParam0, int iParam1) // Position - 0x2EADA
{
	return func_385(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_385(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2EAF2
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_386(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0x2EBB3
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_387(Ped pedParam0, int iParam1) // Position - 0x2ECDF
{
...
BOOL func_389(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x2EDEE
{
	var unk;
...
int func_393(Vehicle veParam0, Ped pedParam1) // Position - 0x2EEFA
{
	int i;
...
BOOL func_394(Vehicle veParam0) // Position - 0x2EF39
{
...
BOOL func_395(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x2EF61
{
...
BOOL func_396(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2EFA8
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_397(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F0A3
{
	float entityCoords;
	float num;
...
BOOL func_398(Vehicle veParam0, float fParam1) // Position - 0x2F1AF
{
	var outProjectile;
	var outCoords;
...
BOOL func_399(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2F244
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_400(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x2F2D2
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x2F3A2
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_404(eCharacter echParam0, int iParam1) // Position - 0x2F443
{
	int num;
...
void func_405(eCharacter echParam0) // Position - 0x2F530
{
...
void func_406(eCharacter echParam0) // Position - 0x2F57B
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_409(eCharacter echParam0) // Position - 0x2FCE8
{
	Hash entityModel;
...
Vehicle func_410(Vehicle veParam0) // Position - 0x2FD54
{
	return veParam0;
}
...
void func_423(Ped pedParam0, var uParam1, int iParam2) // Position - 0x3379E
{
	int taskSequenceId;
	int taskSequenceId2;
...
void func_428(Object* pobParam0) // Position - 0x33E57
{
...
BOOL func_430(Ped pedParam0, Vehicle veParam1) // Position - 0x34040
{
...
void func_434(Vehicle veParam0) // Position - 0x343AA
{
	int taskSequenceId;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x34662
{
...
void func_449(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x34D53
{
	func_450(ppedParam0);
...
void func_450(Ped* ppedParam0) // Position - 0x34D74
{
...
void func_451(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x34DB5
{
	func_452(pveParam0);
...
void func_452(Vehicle* pveParam0) // Position - 0x34DF8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_457(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x353DD
{
...
BOOL func_458(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x35439
{
	Hash model;
...
int func_459(Ped pedParam0, eCharacter echParam1) // Position - 0x354C7
{
	int num;
...
BOOL func_463(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3579A
{
...
char* func_473(char* sParam0) // Position - 0x388B1
{
	return sParam0;
}
...
void func_498(Object* pobParam0, BOOL bParam1) // Position - 0x39D8D
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_501(Vehicle* pveParam0) // Position - 0x39E17
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_504(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x39EA2
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
Hash func_509(eCharacter echParam0) // Position - 0x39F8F
{
	if (!func_36(echParam0))
