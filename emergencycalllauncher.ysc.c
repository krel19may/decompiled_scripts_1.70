...
Hash func_33(Player plParam0) // Position - 0xC92
{
	if (func_35(plParam0))
...
BOOL func_36(eCharacter echParam0) // Position - 0xD24
{
...
{
	Global_33313 = true;
	TEXT_LABEL_ASSIGN_STRING(&Global_33314, SCRIPT::GET_THIS_SCRIPT_NAME(), 32);
	return;
}
