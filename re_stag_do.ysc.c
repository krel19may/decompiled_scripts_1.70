...
eCharacter func_61(int iParam0, BOOL bParam1) // Position - 0x2577
{
	eCharacter character;
	int num;
...
void func_102(ePedComponentType epctParam0, char* sParam1, int iParam2, int iParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x4BD6
{
	int num;
	int i;
...
int func_113(BOOL bParam0) // Position - 0x5215
{
	if (func_117())
	{
		...
		if (bParam0 && func_45(Global_114124))
...
{
	switch (func_118(&Global_33147, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_176() || Global_33090 || func_175() || func_24(8, -1) || func_172() || func_174() || func_173() || func_171() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_176() || Global_113182 || Global_33090 || func_175() || func_24(8, -1) || func_174() || func_173() || func_171() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_176() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_24(8, -1) || func_171() || func_170() || Global_114135.f_7692.f_919[character] == 5)
							return false;
						break;
...
void func_186(int iParam0) // Position - 0x9F0F
{
	...
	if (func_151())
	{
		...
		func_189(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_188(Global_114124, true), 64);
...
void func_198(Vehicle veParam0, eCharacter echParam1) // Position - 0xA722
{
	...
	func_199(veParam0, &(Global_114135.f_32754.f_5510));
	return;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xB64E
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xB664
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_212() // Position - 0xB67A
{
	return false;
}

BOOL func_213() // Position - 0xB683
{
	return true;
}

BOOL func_214() // Position - 0xB68C
{
	return true;
}

BOOL func_215() // Position - 0xB695
{
...
BOOL func_217(Vehicle veParam0) // Position - 0xB6F5
{
	int i;
...
BOOL func_218(Vehicle veParam0) // Position - 0xB730
{
	int i;
...
BOOL func_219(Vehicle veParam0) // Position - 0xB7AC
{
	int i;
...
eCharacter func_220(Vehicle veParam0) // Position - 0xB894
{
	int i;
...
BOOL func_221(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xB8F7
{
	int i;
	var garageName;
	int num;
...
BOOL func_222(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xB965
{
