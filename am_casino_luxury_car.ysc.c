...
BOOL func_23() // Position - 0x54C
{
	...
	if (!func_331(0))
		if (func_125(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), &uLocal_145, &(uLocal_145.f_3)))
			func_124(0);

	if (func_122(func_123()) && func_331(0))
	{
		MISC::CLEAR_AREA(uLocal_145, 5f, true, false, false, false);
	
		if (func_119(&(iLocal_92.f_6), func_123(), uLocal_145, uLocal_145.f_3, true, true, true, false, true, true, false, false, false, false))
		{
			vehicle = func_16();
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xB7E
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

BOOL func_26(Hash hParam0) // Position - 0xB8E
{
	return func_88(hParam0) && !func_27(hParam0);
}

BOOL func_27(Hash hParam0) // Position - 0xBA8
{
	switch (hParam0)
	{
		case joaat("coureur"):
...
BOOL func_28(Hash hParam0) // Position - 0xBDD
{
	switch (hParam0)
	{
		case joaat("pounder2"):
...
void func_29(Vehicle veParam0) // Position - 0xCE4
{
	Hash entityModel;
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0xDB0
{
	int address;
	int i;
	Player player;
...
Hash func_40(int iParam0, int iParam1) // Position - 0xFB7
{
...
int func_46(Vehicle veParam0, Any* panParam1) // Position - 0x1716
{
...
BOOL func_47(Vehicle veParam0) // Position - 0x1793
{
	int vehicleCrewEmblemRequestState;
	int networkTime;
	int num;
...
void func_48(Vehicle veParam0) // Position - 0x1820
{
	int _int;
...
BOOL func_49(var uParam0, Player plParam1) // Position - 0x1878
{
	func_53();
	...
	{
		if (func_50(uParam0, plParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13))
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else
	{
		...
		if (Global_1943806.f_23 == 0 && func_50(uParam0, plParam1, Global_1943806, Global_1943806.f_1, Global_1943806.f_4, Global_1943806.f_7, Global_1943806.f_10, 0, Global_1943806.f_13) || Global_1943806.f_23 != 0 && Global_1943806.f_24 == 0 && func_50(uParam0, plParam1, Global_1943806, Global_1943806.f_14, Global_1943806.f_17, Global_1943806.f_20, Global_1943806.f_10, 1, Global_1943806.f_13) || Global_1943806.f_24 != 0)
		{
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				Global_1577965 = NETWORK::GET_NETWORK_TIME();
			else
...
BOOL func_50(var uParam0, Player plParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, Vector3 vParam9, var uParam10, var uParam11, float fParam12, int iParam13, int iParam14) // Position - 0x1B23
{
...
int func_51(Vehicle veParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1B4C
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		return 0;
...
BOOL func_54(Vehicle veParam0) // Position - 0x791F
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_55(Vehicle veParam0) // Position - 0x7957
{
	int _int;
...
BOOL func_56(Vehicle veParam0, Any* panParam1) // Position - 0x799C
{
	Player playerFromGamerHandle;
	BOOL flag;
	int num;
...
BOOL func_57(Vehicle veParam0) // Position - 0x7AF9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return true;
...
int func_58(Vehicle veParam0) // Position - 0x7E38
{
...
int func_75(Hash hParam0) // Position - 0x812A
{
	switch (hParam0)
	{
		case 0:
...
void func_76(Vehicle veParam0, int iParam1) // Position - 0x8646
{
	int num;
	int num2;
...
BOOL func_82(Vehicle veParam0) // Position - 0x8C06
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
		case joaat("deathbike2"):
...
void func_84(Vehicle veParam0) // Position - 0x8F28
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_85(Vehicle veParam0) // Position - 0x8F5A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("MLJ", BOOL))
			if (!DECORATOR::DECOR_EXIST_ON(veParam0, "MLJ"))
...
BOOL func_86(Hash hParam0) // Position - 0x8F8E
{
	switch (hParam0)
	{
		case 1484920335:
...
BOOL func_87(Hash hParam0) // Position - 0x8FAB
{
...
BOOL func_88(Hash hParam0) // Position - 0x94FC
{
	switch (hParam0)
	{
		case joaat("deity"):
...
void func_89(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x958B
{
	int num;
	int num2;
	int i;
...
BOOL func_90(Vehicle veParam0, float fParam1) // Position - 0x9C8E
{
	float entityCoords;
	var groundZ;
...
Hash func_91(BOOL bParam0) // Position - 0x9CFF
{
	if (bParam0)
...
BOOL func_93(Player plParam0) // Position - 0x9DA8
{
	Player player;
...
BOOL func_94(Player plParam0) // Position - 0x9DCC
{
	Player player;
	...
	if (player != -1)
		return func_95(plParam0, 9);

	return false;
}

BOOL func_95(Player plParam0, int iParam1) // Position - 0x9DEA
{
...
BOOL func_99(Vehicle veParam0) // Position - 0xA012
{
	int i;
	int modType;
	Hash hashKey;
...
int func_101(Vehicle veParam0, int iParam1) // Position - 0xA143
{
	int value;
	int value2;
	float num;
...
int func_102(Vehicle veParam0, int iParam1) // Position - 0xA22C
{
	int i;
...
BOOL func_103(Hash hParam0) // Position - 0xA28E
{
...
BOOL func_104(Hash hParam0, int iParam1) // Position - 0xA2B9
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_105(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xA698
{
...
void func_107(Vehicle veParam0, int iParam1) // Position - 0xA6C5
{
	int vehicleMod;
...
BOOL func_110(Vehicle veParam0) // Position - 0xA76E
{
	int _int;
...
BOOL func_114(Vehicle veParam0) // Position - 0xA8D3
{
...
void func_118(Vehicle veParam0) // Position - 0xACC6
{
...
BOOL func_119(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15) // Position - 0xACE0
{
	float radius;
	Vehicle vehicle;
...
void func_120(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Vehicle veParam5) // Position - 0xADF8
{
	int i;
...
int func_121(Player plParam0, var uParam1, var uParam2, var uParam3, Hash hParam4) // Position - 0xAECB
{
	Player player;
	int i;
	Vector3 vector;
...
BOOL func_122(Hash hParam0) // Position - 0xAF69
{
	if (hParam0 == 0)
		return true;
...
void func_124(int iParam0) // Position - 0xAF9F
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&uLocal_142[num], offset);
	return;
}
...
BOOL func_126(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, Hash hParam6, int iParam7, var uParam8, var uParam9, var uParam10) // Position - 0xB05C
{
	BOOL flag;
	int i;
	int num;
	...
	{
		if (!(Global_2635516.f_677 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635516.f_680) < func_269(false))
				return false;
			else
				Global_2635516.f_677 = 0;
	}
	else
	{
		...
		if (!(Global_2635516.f_677 == 0))
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635516.f_680) > func_269(true))
				Global_2635516.f_677 = 0;
	}
	...
	switch (Global_2635516.f_677)
	{
		case 2:
			if (PATHFIND::ARE_NODES_LOADED_FOR_AREA(fParam0 - 100f, fParam0.f_1 - 100f, fParam0 + 100f, fParam0.f_1 + 100f))
			{
				...
				if (uParam10->f_3 && func_211(fParam0, num2, num3, num4, 1f, false, false, false, 1123024896, false, -1, true, 0, false, 0, false, false) && !uParam10->f_7 && !func_209(fParam0, *uParam9, hParam6, PLAYER::PLAYER_ID(), 0))
				{
					Global_2635516.f_684 = { fParam0 };
				...
				func_150(Global_2635516.f_684, Global_2635516.f_687, hParam6, &(Global_2635516.f_674));
			...
			if (Global_2635516.f_672)
			{
				if (Global_2635516.f_674 == Global_2635516.f_675)
				{
					if (Global_2635516.f_673)
					{
						...
						{
							if (func_149(Global_2635516.f_684, Global_2635516.f_687, hParam6, true, 1036831949))
							{
				...
				if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635516.f_701) < 10000)
				{
					if (NETWORK::NETWORK_ENTITY_AREA_DOES_EXIST(Global_2635516.f_700))
					{
						if (NETWORK::NETWORK_ENTITY_AREA_HAVE_ALL_REPLIED(Global_2635516.f_700))
						{
							...
							{
								if (func_145(Global_2635516.f_684, Global_2635516.f_687, hParam6, PLAYER::PLAYER_ID(), 0) || func_128(Global_2635516.f_684, Global_2635516.f_687, hParam6, true, false, false, false, 1, false))
								{
									func_147(Global_2635516.f_684, 0);
									func_146(-1);
								}
...
BOOL func_128(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9, BOOL bParam10) // Position - 0xBB0C
{
	Player i;
	Player player;
	float num;
							...
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(player), false))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn, false))
									{
										...
										if (func_138(uParam0, fParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
											return true;
									}
									else
									{
								...
								if (func_129(_GET_PLAYER_COORDS(player), uParam0, fParam3, hParam4, num))
									return true;
							}
						}
					}
...
BOOL func_129(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Hash hParam7, int iParam8) // Position - 0xBC7F
{
	Vector3 vector;
	Vector3 vector2;
	float width;

	if (SYSTEM::VDIST(vParam0, vParam3) < func_137(hParam7, 1008981770))
	{
		func_130(vParam3, fParam6, hParam7, &vector, &vector2, &width, iParam8);
...
void func_130(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, var uParam5, var uParam6, Any anParam7, int iParam8) // Position - 0xBCD2
{
	Vector3 vector;
	var unk3;
	float num;
...
void func_131(Hash hParam0, Vector3* pvParam1, Vector3* pvParam2, int iParam3, int iParam4, int iParam5) // Position - 0xBD9E
{
	int num;
...
void func_132(int iParam0, Vector3* pvParam1, Vector3* pvParam2, int iParam3, int iParam4, int iParam5) // Position - 0xBE9D
{
	int i;
...
int func_134(Hash hParam0) // Position - 0xC12E
{
	int i;
	int num;
...
Hash func_135(int iParam0) // Position - 0xC15D
{
	Hash num;
...
void func_136(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xC16F
{
	float num;
	float num2;
	float num3;
...
float func_137(Hash hParam0, int iParam1) // Position - 0xC246
{
	var unk;
	var unk4;
	float num;
...
BOOL func_138(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, var uParam5, var uParam6, var uParam7, float fParam8, Hash hParam9, int iParam10) // Position - 0xC2C6
{
	if (func_129(uParam0, uParam5, fParam8, hParam9, 1036831949))
		return true;

	func_130(uParam0, fParam3, hParam4, &Global_1976100, &(Global_1976100.f_3), &(Global_1976100.f_6), 1036831949);
	func_130(uParam5, fParam8, hParam9, &(Global_1976100.f_7), &(Global_1976100.f_10), &(Global_1976100.f_13), 1036831949);
...
BOOL func_140(Player plParam0, Player plParam1) // Position - 0xC3AB
{
	Player player;
...
struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0xC3F7
{
	var gamerHandle;
...
BOOL func_143(Player plParam0, Player plParam1) // Position - 0xC40E
{
...
BOOL func_145(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xC4A7
{
	Player i;
	Player player;
		...
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
				if (Global_2648914.f_261[i])
					if (func_129(Global_2648914.f_131[i /*3*/], uParam0, fParam3, hParam4, 1036831949))
						return true;
				else if (func_129(_GET_PLAYER_COORDS(player), uParam0, fParam3, hParam4, 1036831949))
					return true;
				...
				if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(player)))
					if (func_129(_GET_PLAYER_COORDS(player), uParam0, fParam3, hParam4, 1036831949))
						return true;
		}
	}
...
BOOL func_149(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xC6C5
{
	Vector3 vector;
	Vector3 vector2;
	var unk5;
	...
	else
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			...
			{
				func_130(uParam0, fParam3, hParam4, &vector, &vector2, &unk5, iParam6);
...
void func_150(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, var uParam5) // Position - 0xC796
{
	Hash eventData;

	*uParam5 = func_151(&uParam0, &fParam3, &hParam4);
	eventData = 323285304;
	eventData.f_1 = PLAYER::PLAYER_ID();
	eventData.f_3 = { uParam0 };
	eventData.f_6 = fParam3;
...
Hash func_151(var uParam0, var uParam1, var uParam2) // Position - 0xC7E8
{
	var unk;
	Hash hashKey;
...
void func_152(var uParam0, float fParam1, var uParam2) // Position - 0xC836
{
	int i;
	...
	{
		for (i = 0; func_203(uParam0, fParam1, uParam2) == 0 && i < 2; i = i + 1)
		{
		}
	...
	for (i = 0; func_153(uParam0, fParam1, uParam2) == 0 && i < 6; i = i + 1)
	{
	}
...
int func_153(var uParam0, float fParam1, var uParam2) // Position - 0xC8A5
{
	int num;
	float outPosition;
	float outPosition2;
	...
	while (true)
	{
			...
			if (num >= 40 + num4 || num >= 100)
			{
				if (Global_2643430.f_162 > 0 && uParam2->f_29 || uParam2->f_30 || uParam2->f_33 >= 2)
				{
					if (uParam2->f_30)
					{
						...
						*fParam1 = Global_2643430.f_121[0];
						return 1;
					}
					else
					{
		...
		else
		{
			...
			{
				func_154(&Global_1574205, uParam0, fParam1, *uParam0);
...
void func_154(var uParam0, var uParam1, float fParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xD2D3
{
	float num;
	float num2;
	int i;
...
void func_158(int iParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, Vector3* pvParam5, float* pfParam6, var uParam7, BOOL bParam8, int iParam9, int iParam10, float fParam11, float fParam12, BOOL bParam13) // Position - 0xD567
{
	int i;
...
BOOL func_172(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Hash hParam4) // Position - 0xDD60
{
	int flags;
	...
	if (ENTITY::DOES_ENTITY_EXIST(closestVehicle) && !ENTITY::IS_ENTITY_DEAD(closestVehicle, false))
	{
		...
		if (func_138(vParam0, fParam3, hParam4, entityCoords, entityHeading, entityModel, 0))
			return true;
	}
...
BOOL func_173(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Player plParam5, int iParam6, int iParam7) // Position - 0xDE6C
{
	if (func_145(uParam0, fParam3, hParam4, plParam5, iParam6) || func_209(uParam0, fParam3, hParam4, plParam5, iParam7))
		return true;

	return false;
}

BOOL func_174(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDEA2
{
	if (uParam3->f_18)
	{
		switch (uParam3->f_26)
...
Vector3 func_179(Vector3 vParam0, var uParam1, var uParam2, float* pfParam3, int iParam4, BOOL bParam5, Vector3 vParam6, var uParam7, var uParam8, BOOL bParam9, BOOL bParam10, Hash hParam11, var uParam12, BOOL bParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16) // Position - 0xE387
{
...
float func_180(Hash hParam0, float fParam1) // Position - 0xE7D6
{
	var unk;
	float num;
	float num2;
...
BOOL func_181(float fParam0, var uParam1, var uParam2) // Position - 0xE80D
{
	float groundZ;
...
BOOL func_182(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6) // Position - 0xE845
{
	var unk;
	var unk4;

	unk = { 0f, 1f, 0f };
	func_136(&unk, 0f, 0f, fParam3);
...
BOOL func_185(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0xE91D
{
...
BOOL func_187(var uParam0, BOOL bParam1) // Position - 0xE9D8
{
	...
	if (func_193(*uParam0))
	{
		if (bParam1)
		{
			...
			func_192(&unk2, Global_2635516.f_594, Global_2635516.f_597, 1036831949, false, randomFloatInRange);
		
			if (func_188(unk2, &unk) || func_193(unk2))
			{
				unk2 = { *uParam0 };
				func_192(&unk2, Global_2635516.f_594, Global_2635516.f_597, 1036831949, true, randomFloatInRange);
			}
...
BOOL func_189(Vector3 vParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEAD4
{
	switch (uParam3->f_10)
	{
		case 0:
			return func_177(vParam0, *uParam3, uParam3->f_6 + iParam4 + ((float)Global_2635516.f_3036 * uParam3->f_8), bParam5, bParam6);
...
void func_192(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6, float fParam7) // Position - 0xEC77
{
	Vector3 vector;
	var unk3;
...
Vector3 func_195(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10, int iParam11, BOOL bParam12) // Position - 0xEE4A
{
	int i;
	Vector3 outPosition;
...
int func_203(var uParam0, float fParam1, var uParam2) // Position - 0xF679
{
	int randomIntInRange;
	int i;
	int num;
	...
	if (Global_2635516.f_2055 > 0)
	{
		...
		else
		{
			...
			else if (uParam2->f_59 && Global_2635516.f_2055 > 0)
			{
				...
				*fParam1 = Global_2635516.f_2056[randomIntInRange /*4*/].f_3;
				return 1;
			}
			else
			{
...
BOOL func_208(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xFE73
{
...
BOOL func_209(var uParam0, var uParam1, var uParam2, float fParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xFEB0
{
	Player i;
	int j;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (func_210(uParam0, hParam4, Global_2648914.f_461[i /*11*/][j /*5*/], Global_2648914.f_461[i /*11*/][j /*5*/].f_4))
					if (func_138(uParam0, fParam3, hParam4, Global_2648914.f_461[i /*11*/][j /*5*/], Global_2648914.f_461[i /*11*/][j /*5*/].f_3, Global_2648914.f_461[i /*11*/][j /*5*/].f_4, 0))
						if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
							return true;
						else
							return true;
...
BOOL func_210(Vector3 vParam0, var uParam1, var uParam2, Hash hParam3, Vector3 vParam4, var uParam5, var uParam6, Hash hParam7) // Position - 0xFF8A
{
	float num;
	float num2;
	float num3;
...
BOOL func_211(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, float fParam10, BOOL bParam11, int iParam12, BOOL bParam13, int iParam14, BOOL bParam15, int iParam16, BOOL bParam17, BOOL bParam18) // Position - 0xFFCA
{
...
BOOL func_212(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x100DE
{
	Player i;
	Player player;
	int num;
...
BOOL func_217() // Position - 0x10354
{
	return Global_2684718.f_19;
}

BOOL func_218(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x10362
{
	Player i;
	Player player;
...
void func_219(Hash hParam0) // Position - 0x10466
{
	int randomIntInRange;
...
int func_224(Hash hParam0) // Position - 0x10B0D
{
	switch (hParam0)
	{
		case joaat("microlight"):
	...
	*uParam3 = -1;
	...
	if (!(num == -1))
	{
		for (i = 83; i <= 87; i = i + 1)
		{
			...
			if (func_227(hash))
			{
				if (func_239(Global_1943917.f_754[i /*3*/], 0) == num)
				{
					*uParam3 = i + 1000;
					return true;
				}
...
BOOL func_227(Hash hParam0) // Position - 0x10D3F
{
	int num;
	Player player;
	...
	if (Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_299 == num)
		return true;

	player = Global_1887549[PLAYER::PLAYER_ID() /*611*/].f_10;
	...
	if (func_236(PLAYER::PLAYER_ID(), false) || func_233(PLAYER::PLAYER_ID()) && func_75(func_232(PLAYER::PLAYER_ID())) == 12)
		return true;
...
Hash func_232(Player plParam0) // Position - 0x10FE7
{
...
Hash func_237() // Position - 0x11141
{
...
int func_239(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x111AA
{
	...
	for (i = 0; i < 14; i = i + 1)
	{
		if (Global_2640779[i /*17*/].f_9 == true || iParam3 == 0)
...
void func_240(var uParam0, var uParam1, var uParam2, Hash hParam3) // Position - 0x111FE
{
	int i;
	int num;
	int num2;
	...
	if (!func_259())
	{
		...
		else
		{
			...
			if (func_251(uParam0, &num2, &unk4) || func_226(uParam0, &num2[0]) && VEHICLE::IS_THIS_MODEL_A_PLANE(hParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(hParam3))
			{
				func_270();
				...
				for (i = 0; i < num2; i = i + 1)
				{
					...
					{
						if (func_249(PLAYER::PLAYER_PED_ID()) || func_247(PLAYER::PLAYER_PED_ID()) && VEHICLE::IS_THIS_MODEL_A_PLANE(hParam3) || VEHICLE::IS_THIS_MODEL_A_HELI(hParam3))
						{
							if (func_246(hParam3))
							{
								func_245(num2[i]);
							}
							else if (func_244(hParam3))
							{
								func_243(num2[i]);
								func_245(num2[i]);
							}
...
void func_241(int iParam0, Hash hParam1) // Position - 0x11FF6
{
	switch (iParam0)
	{
		case 23:
		...
		case 124:
		case 125:
			func_242(896.357f, -3.23695f, 77.7645f, 147.3987f, hParam1, false);
			func_242(899.759f, -5.54885f, 77.7645f, 147.3987f, hParam1, false);
			func_242(903.021f, -7.62495f, 77.7645f, 147.3987f, hParam1, false);
			func_242(906.474f, -9.70314f, 77.7645f, 147.3987f, hParam1, false);
			func_242(909.884f, -11.888f, 77.7645f, 147.3987f, hParam1, false);
			func_242(913.209f, -14.0965f, 77.7645f, 147.3987f, hParam1, false);
			func_242(879.578f, 7.26725f, 77.7646f, 147.3987f, hParam1, false);
			func_242(876.642f, 9.05555f, 77.7646f, 147.3987f, hParam1, false);
			func_242(873.534f, 10.8622f, 77.7646f, 147.3987f, hParam1, false);
			func_242(869.685f, -7.55887f, 77.7646f, 237.3985f, hParam1, false);
			func_242(867.866f, -10.464f, 77.7646f, 237.3985f, hParam1, false);
			func_242(866.077f, -13.4579f, 77.7646f, 237.3985f, hParam1, false);
			func_242(864.322f, -16.4335f, 77.7646f, 237.3985f, hParam1, false);
			func_242(862.534f, -19.2652f, 77.7644f, 237.3985f, hParam1, false);
			func_242(887.524f, -18.7251f, 77.7647f, 237.3985f, hParam1, false);
			func_242(885.594f, -21.7041f, 77.7647f, 237.3985f, hParam1, false);
			func_242(883.691f, -24.7685f, 77.7647f, 237.3985f, hParam1, false);
			func_242(881.827f, -27.7084f, 77.7644f, 237.3985f, hParam1, false);
			func_242(880.013f, -30.5612f, 77.7644f, 237.3985f, hParam1, false);
			func_242(884.931f, -17.2169f, 77.7646f, 57.5983f, hParam1, false);
			func_242(883.043f, -20.1063f, 77.7646f, 57.5983f, hParam1, false);
			func_242(881.118f, -22.9962f, 77.7644f, 57.5983f, hParam1, false);
			func_242(879.345f, -25.9389f, 77.7644f, 57.5983f, hParam1, false);
			func_242(877.631f, -28.8543f, 77.7644f, 57.5983f, hParam1, false);
			func_242(903.231f, -28.6965f, 77.7647f, 57.5983f, hParam1, false);
			func_242(901.368f, -31.6316f, 77.7647f, 57.5983f, hParam1, false);
			func_242(899.552f, -34.4844f, 77.7647f, 57.5983f, hParam1, false);
			func_242(897.669f, -37.4419f, 77.7647f, 57.5983f, hParam1, false);
			func_242(895.831f, -40.3309f, 77.7647f, 57.5983f, hParam1, false);
			func_242(932.842f, -25.6631f, 77.7647f, 147.798f, hParam1, false);
			func_242(935.693f, -27.516f, 77.7647f, 147.798f, hParam1, false);
			func_242(938.593f, -29.5809f, 77.7647f, 147.798f, hParam1, false);
			break;
	
		case 165:
			func_242(-14.562f, -1298.2373f, 28.323f, 181.7987f, hParam1, false);
			func_242(-18.7554f, -1298.3212f, 28.3238f, 181.7987f, hParam1, false);
			func_242(-8.76f, -1306.7644f, 28.4274f, 270.5988f, hParam1, false);
			func_242(-0.9861f, -1306.9889f, 29.0661f, 268.5986f, hParam1, false);
			func_242(7.095f, -1306.7876f, 29.081f, 269.7986f, hParam1, false);
			func_242(15.0002f, -1306.9833f, 28.1188f, 269.7986f, hParam1, false);
			func_242(22.4783f, -1307.6133f, 28.2369f, 270.5979f, hParam1, false);
			func_242(30.1251f, -1307.5502f, 28.2089f, 270.5979f, hParam1, false);
			func_242(-58.9301f, -1319.5089f, 28.1072f, 89.1976f, hParam1, false);
			func_242(-66.4231f, -1319.25f, 28.0882f, 89.1976f, hParam1, false);
			break;
	
		case 162:
			func_242(-215.8533f, 6310.631f, 30.2933f, 315.3986f, hParam1, false);
			func_242(-221.6996f, 6304.683f, 30.2887f, 315.3986f, hParam1, false);
			func_242(-227.5227f, 6298.8867f, 30.2886f, 315.3986f, hParam1, false);
			func_242(-233.4945f, 6293.001f, 30.2907f, 315.3986f, hParam1, false);
			func_242(-199.5962f, 6321.835f, 30.4171f, 315.3986f, hParam1, false);
			func_242(-219.9854f, 6323.075f, 30.3012f, 135.3982f, hParam1, false);
			func_242(-214.4723f, 6328.4194f, 30.3033f, 135.3982f, hParam1, false);
			func_242(-228.3779f, 6314.325f, 30.2951f, 135.3982f, hParam1, false);
			func_242(-233.6126f, 6309.157f, 30.2805f, 135.3982f, hParam1, false);
			func_242(-239.0836f, 6303.774f, 30.3162f, 135.3982f, hParam1, false);
			break;
	
		case 166:
			func_242(1199.3922f, -1274.6459f, 34.2218f, 264.5996f, hParam1, false);
			func_242(1199.8231f, -1270.8417f, 34.2267f, 264.5996f, hParam1, false);
			func_242(1211.7864f, -1273.5059f, 34.2265f, 84.7993f, hParam1, false);
			func_242(1211.3959f, -1277.511f, 34.2265f, 84.7993f, hParam1, false);
			func_242(1198.3217f, -1289.7107f, 34.2104f, 265.7991f, hParam1, false);
			func_242(1190.971f, -1289.0333f, 33.9762f, 265.7991f, hParam1, false);
			func_242(1183.6307f, -1288.7725f, 33.8503f, 265.7991f, hParam1, false);
			func_242(1212.6528f, -1290.9677f, 34.2268f, 265.7991f, hParam1, false);
			func_242(1219.9164f, -1291.5703f, 34.2231f, 265.7991f, hParam1, false);
			func_242(1227.2478f, -1292.124f, 34.2049f, 214.5982f, hParam1, false);
			break;
	
		case 164:
			func_242(-513.4792f, -1725.9542f, 18.2396f, 233.7993f, hParam1, false);
			func_242(-502.8869f, -1724.6547f, 18.3531f, 191.7995f, hParam1, false);
			func_242(-500.5194f, -1731.9363f, 17.9393f, 202.9996f, hParam1, false);
			func_242(-519.8862f, -1723.5706f, 18.186f, 326.1996f, hParam1, false);
			func_242(-522.9067f, -1721.4664f, 18.2f, 326.1996f, hParam1, false);
			func_242(-525.8917f, -1719.2316f, 18.2055f, 326.1996f, hParam1, false);
			func_242(-528.915f, -1717.2086f, 18.2224f, 326.1996f, hParam1, false);
			func_242(-532.0991f, -1714.7692f, 18.2197f, 326.1996f, hParam1, false);
			func_242(-541.5544f, -1713.4291f, 18.159f, 260.1992f, hParam1, false);
			func_242(-547.5757f, -1708.4988f, 18.0875f, 214.5982f, hParam1, false);
			break;
	
		case 163:
			func_242(2503.9746f, 4105.65f, 37.3197f, 333.9991f, hParam1, false);
			func_242(2500.5635f, 4098.3643f, 37.2041f, 333.9991f, hParam1, false);
			func_242(2496.8916f, 4090.8677f, 37.0864f, 333.9991f, hParam1, false);
			func_242(2493.136f, 4083.078f, 36.9669f, 333.9991f, hParam1, false);
			func_242(2489.5542f, 4075.2004f, 36.8805f, 333.9991f, hParam1, false);
			func_242(2491.6594f, 4121.725f, 37.1767f, 155.199f, hParam1, false);
			func_242(2488.2144f, 4123.2705f, 37.1377f, 155.199f, hParam1, false);
			func_242(2484.7336f, 4124.911f, 37.0531f, 155.199f, hParam1, false);
			func_242(2484.46f, 4113.972f, 37.0647f, 336.7987f, hParam1, false);
			func_242(2480.8772f, 4115.4917f, 37.0647f, 336.7987f, hParam1, false);
			break;
...
void func_242(float fParam0, float fParam1, float fParam2, float fParam3, Hash hParam4, BOOL bParam5) // Position - 0x16440
{
	var unk;
	var unk4;
	float num;
...
BOOL func_244(Hash hParam0) // Position - 0x17A89
{
	switch (hParam0)
	{
		case joaat("microlight"):
...
BOOL func_246(Hash hParam0) // Position - 0x1811A
{
	switch (hParam0)
	{
		case joaat("hydra"):
...
int func_247(Ped pedParam0) // Position - 0x181D0
{
	if (func_248(pedParam0))
		return 1;

	return 0;
}

BOOL func_248(Ped pedParam0) // Position - 0x181E6
{
...
int func_249(Ped pedParam0) // Position - 0x18224
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;
...
BOOL func_252(Hash hParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x18526
{
	float num;

	if (hParam0 == -1 || func_75(hParam0) != 28)
		return 0;
	...
	switch (hParam0)
	{
		...
		case 163:
		case 165:
			num = SYSTEM::VDIST(fParam1, fParam1.f_1, 0f, Global_1943917.f_754[hParam0 /*3*/], Global_1943917.f_754[hParam0 /*3*/].f_1, 0f);
...
BOOL func_253(Hash hParam0) // Position - 0x18662
{
	int num;
	Player player;

	num = func_254(hParam0);

	if (Global_1845221[PLAYER::PLAYER_ID() /*889*/].f_268.f_306 == num)
		return true;
...
int func_254(Hash hParam0) // Position - 0x186CA
{
	switch (hParam0)
	{
		case 89:
...
BOOL func_255(Hash hParam0) // Position - 0x18751
{
...
void func_256(Hash hParam0) // Position - 0x1877F
{
	switch (hParam0)
	{
		case 78:
...
BOOL func_263(var uParam0, var uParam1, var uParam2) // Position - 0x19B9C
{
	...
	if (!Global_2635516.f_516 && !Global_2635516.f_517)
	{
		...
		{
			if (!func_267(PLAYER::PLAYER_ID(), true))
				return true;
...
BOOL func_272() // Position - 0x19E80
{
	...
	if (!IS_BIT_SET(Global_2638770, 0) && Global_2635516.f_681 == MISC::GET_FRAME_COUNT() - 1)
		return true;
...
{
	if (!(Global_2635516.f_607 == 0) && NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2635516.f_612) < func_269(false))
		return true;
...
BOOL func_274() // Position - 0x19EF0
{
	...
	if (!func_275(PLAYER::PLAYER_ID()) && !func_215(false))
		return false;

	return true;
}

BOOL func_275(Player plParam0) // Position - 0x19F47
{
	if (!func_35(plParam0))
		return false;
...
void func_278(int iParam0) // Position - 0x19F86
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&iLocal_92.f_2[num], offset);
	return;
}

void func_279(Player plParam0) // Position - 0x19FB5
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;

	iLocal_92.f_5 = plParam0;
	return;
}
...
{
	uLocal_100[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
	return;
}

int func_282(Player plParam0) // Position - 0x1A054
{
	return uLocal_100[plParam0 /*4*/].f_1;
}
...
BOOL func_288(Player plParam0) // Position - 0x1A0F6
{
...
BOOL func_290(Player plParam0, int iParam1) // Position - 0x1A160
{
	int num;
	int num2;
	...
	num = iParam1 / 32;
	num2 = iParam1 % 32;
	return IS_BIT_SET(uLocal_100[plParam0 /*4*/].f_2[num], num2);
}
...
BOOL func_295(Player plParam0) // Position - 0x1A1DC
{
...
void func_296() // Position - 0x1A1EC
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_302(PLAYER::PLAYER_PED_ID(), func_16(), 120f, true))
		if (!func_290(NETWORK::PARTICIPANT_ID(), 1))
			func_301(1);
...
BOOL func_297() // Position - 0x1A263
{
	if (func_294())
	{
		if (!func_302(PLAYER::PLAYER_PED_ID(), func_16(), 1000f, true))
			return true;
	
		if (func_299(PLAYER::PLAYER_ID(), true, true))
			return true;
...
BOOL func_298(Player plParam0) // Position - 0x1A2CF
{
...
void func_300(int iParam0) // Position - 0x1A36C
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::CLEAR_BIT(&uLocal_100[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[num], offset);
	return;
}
...
void func_301(int iParam0) // Position - 0x1A396
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&uLocal_100[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2[num], offset);
	return;
}

BOOL func_302(Ped pedParam0, Vehicle veParam1, float fParam2, BOOL bParam3) // Position - 0x1A3C0
{
...
void func_304() // Position - 0x1A3F6
{
	...
	if (num != func_306())
	{
		switch (func_306())
		{
			...
			case 0:
				if (func_294() && !func_290(NETWORK::PARTICIPANT_ID(), 0) && num == 2)
					func_301(0);
				break;
		}
...
BOOL func_308(Player plParam0) // Position - 0x1A4A7
{
	if (func_35(plParam0))
		if (func_35(Global_1887549[plParam0 /*611*/].f_10))
...
BOOL func_310(Player plParam0, BOOL bParam1) // Position - 0x1A4EE
{
	if (!func_35(plParam0))
		return false;
	...
	return func_35(Global_1887549[plParam0 /*611*/].f_10);
}
...
int func_313(Vehicle veParam0) // Position - 0x1A688
{
	int i;
	int num;
	int num2;
...
BOOL func_314(int iParam0) // Position - 0x1A6CF
{
...
BOOL func_315(int iParam0) // Position - 0x1A704
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
...
void func_316() // Position - 0x1A726
{
	if (func_322())
	{
		...
		{
			blLocal_149 = HUD::ADD_BLIP_FOR_ENTITY(func_16());
			HUD::SET_BLIP_SPRITE(blLocal_149, func_321());
			func_318(&blLocal_149, func_320());
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_149, func_317());
		}
	}
	else if (HUD::DOES_BLIP_EXIST(blLocal_149))
	{
...
int func_319(eHudColour ehcParam0) // Position - 0x1A7AA
{
	int r;
	int g;
	int b;
...
eBlipSprite func_321() // Position - 0x1AA1C
{
...
{
	uLocal_100[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
	return;
}
...
int func_327(Player plParam0) // Position - 0x1AAA2
{
	return uLocal_100[plParam0 /*4*/];
}
...
void func_328() // Position - 0x1AAB0
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		...
		{
			uLocal_133[i] = i;
			playerIndex = NETWORK::NETWORK_GET_PLAYER_INDEX(uLocal_133[i]);
...
void func_329(int iParam0) // Position - 0x1ABCC
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::CLEAR_BIT(&iLocal_92.f_2[num], offset);
	return;
}
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x1ACA7
{
	switch (func_43())
	{
		case 0:
...
Hash func_334() // Position - 0x1ACDA
{
...
BOOL func_345(Player plParam0) // Position - 0x1AE11
{
...
BOOL func_347(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x1AE40
{
	...
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_92, 8, 0);
