...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1645.5549f, -1123.872f, 17.3436f, 300f, 300f, 300f, false, true, 0) || _IS_FMMC_ACTIVE() || NETWORK::NETWORK_IS_ACTIVITY_SESSION() || func_177() && !func_175())
		...
		case 0:
			...
			else
			{
				...
				if (IS_BIT_SET(iLocal_1140.f_3[NETWORK::PARTICIPANT_ID_TO_INT()], 0))
				{
					...
					{
						if (Global_2748103 != iLocal_1140.f_36[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 /*10*/].f_6)
						{
...
void _STOPWATCH_RESET(int pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5C1A
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL func_58(Ped pedParam0) // Position - 0x6271
{
...
void func_59(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x62A2
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x6372
{
	Hash statName;
...
BOOL func_62(Player plParam0) // Position - 0x63E6
{
...
BOOL func_64(Player plParam0, int iParam1) // Position - 0x6433
{
	BOOL flag;
...
BOOL func_67(Player plParam0) // Position - 0x64D9
{
	int num;
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x68F2
{
	Hash eventData;
...
BOOL func_77(int iParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x69C5
{
	if (iParam2 == -1)
		return true;
...
void func_81(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6ABD
{
...
void func_83(Hash hParam0) // Position - 0x6B8A
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_84() /*5571*/].f_681.f_4245[i /*3*/] == hParam0)
		{
...
void func_98(const char* sParam0) // Position - 0x74F1
{
...
void func_99(const char* sParam0) // Position - 0x7503
{
...
void func_104(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0x755A
{
	int num;
...
void func_120(BOOL bParam0, int iParam1, int iParam2) // Position - 0x8405
{
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x853B
{
	int num;
...
int func_126(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8EAE
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_127(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x905B
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_129(Hash hParam0) // Position - 0x90E7
{
	hParam0->f_65 = 0;
...
void func_132(int iParam0, Hash hParam1) // Position - 0x9265
{
...
int func_133(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x9279
{
	int i;
...
BOOL _IS_PLAYER_IN_ANIMAL_FORM(Player plParam0) // Position - 0x9511
{
	Ped playerPed;
	Hash entityModel;
...
BOOL func_144(Ped pedParam0) // Position - 0x957D
{
...
BOOL func_145(Player plParam0, int iParam1) // Position - 0x95B5
{
	return IS_BIT_SET(Global_2657991[plParam0 /*467*/].f_221, iParam1);
}

BOOL func_146(Player plParam0) // Position - 0x95CB
{
...
BOOL func_147(Player plParam0) // Position - 0x95EE
{
	Player player;
...
BOOL func_148(Player plParam0, int iParam1) // Position - 0x960C
{
	return IS_BIT_SET(Global_1887549[plParam0 /*611*/].f_10.f_4, iParam1);
}

BOOL func_149(Player plParam0) // Position - 0x9624
{
	Player player;
...
void func_152() // Position - 0x96B5
{
	...
	if (func_44(obLocal_305))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(obLocal_305, -Global_2748103 - (360f / 16f), 0f, 0f, 2, true);
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x9870
{
...
void func_159() // Position - 0x99A5
{
	...
	ENTITY::SET_ENTITY_COORDS(obLocal_305, uLocal_307, true, false, false, true);
	ENTITY::SET_ENTITY_ROTATION(obLocal_305, Global_2748103, 0f, 0f, 2, true);
	ENTITY::FREEZE_ENTITY_POSITION(obLocal_305, true);
...
void func_167(int iParam0) // Position - 0x9D75
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 3))
		{
			...
			func_168(func_136(eventData.f_1), flag);
...
void func_169(int iParam0) // Position - 0x9DEF
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 3))
			func_170(func_136(eventData.f_1));
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0xA0BF
{
	switch (func_28())
	{
		case 0:
...
void func_197() // Position - 0xA4FD
{
	...
	func_42(&iLocal_317);
	func_42(&iLocal_318);
	func_198(&obLocal_305);
	return;
}

void func_198(Object* pobParam0) // Position - 0xA580
{
